...
type
  TForm2 = class(TForm)
    ...
    procedure fb_AllClick(Sender: TObject);
  private
...
begin
  if IDNO = Application.MessageBox(PChar('사용자 그룹 권한을 저장하시겠습니까?'),'작업안내', MB_YesNo) then Exit;
...
procedure TForm2.fb_AllClick(Sender: TObject);
begin
  // 일괄 복사 오픈
