...
uses
  ...
  Db, MemDS, DBAccess, Ora, QuickRpt, Qrctrls, ExtCtrls;
...
uses PIA80201, PePrnview;

{$R *.DFM}

{ TForm1 }

procedure TPrintForm2.ChildBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  with OraQuery1  do
  begin
...
procedure TPrintForm2.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  with OraQuery1  do
  begin
...
procedure TPrintForm2.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TPrintForm2.QuickRep1EndPage(Sender: TCustomQuickRep);
begin
   Inc(PageCount);
end;
