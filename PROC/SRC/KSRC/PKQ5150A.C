...
static unsigned int sqlctx = 154371;
...
extern void sqliem(/*_ unsigned char *, signed int * _*/);
 ...
 static char *sq0006 = 
"select bacode  from pkmbank where ((mbacode=:b0 and bacode<>:b0) and bacode\
 in (select paybank  from pkhmrhis where mrtodate=:b2 group by paybank)) orde\
r by bacode            ";

 static char *sq0007 = 
"select max(empno) ,paybank ,payacnt ,sum(NVL(realamt,0))  from pkhmrhis whe\
re (paybank=:b0 and mrtodate=:b1) group by paybank,payacnt           ";
...
192,0,0,6,175,0,9,302,0,0,3,3,0,1,0,1,97,0,0,1,97,0,0,1,97,0,0,
219,0,0,6,0,0,13,315,0,0,1,0,0,1,0,2,97,0,0,
238,0,0,6,0,0,15,320,0,0,0,0,0,1,0,
253,0,0,6,0,0,15,327,0,0,0,0,0,1,0,
268,0,0,7,144,0,9,366,0,0,2,2,0,1,0,1,97,0,0,1,97,0,0,
291,0,0,7,0,0,13,380,0,0,4,0,0,1,0,2,97,0,0,2,97,0,0,2,97,0,0,2,3,0,0,
322,0,0,7,0,0,15,391,0,0,0,0,0,1,0,
337,0,0,7,0,0,15,398,0,0,0,0,0,1,0,
352,0,0,8,50,0,3,605,0,0,5,5,0,2,6,76,79,71,95,68,66,1,97,0,0,1,97,0,0,1,3,0,0,
1,97,0,0,1,97,0,0,
393,0,0,9,0,0,29,615,0,0,0,0,0,2,6,76,79,71,95,68,66,
};
...

{
     ...
     sqlstm.sqadto[1] = (unsigned short )0;
     sqlstm.sqtdso[1] = (unsigned short )0;
     sqlstm.sqhstv[2] = (unsigned char  *)caldate;
     sqlstm.sqhstl[2] = (unsigned long )9;
     sqlstm.sqhsts[2] = (         int  )0;
     sqlstm.sqindv[2] = (         short *)0;
     sqlstm.sqinds[2] = (         int  )0;
...

{
     ...
     sqlstm.sqadto[0] = (unsigned short )0;
     sqlstm.sqtdso[0] = (unsigned short )0;
     sqlstm.sqhstv[1] = (unsigned char  *)caldate;
