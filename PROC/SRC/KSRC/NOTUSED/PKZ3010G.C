...
static unsigned int sqlctx = 156275;
...
static struct sqlexd {
   ...
   unsigned int   sqcmod;
   unsigned int   sqfmod;
   unsigned char  *sqhstv[129];
   unsigned long  sqhstl[129];
            int   sqhsts[129];
            short *sqindv[129];
            int   sqinds[129];
   unsigned long  sqharm[129];
   unsigned long  *sqharc[129];
...
om PKCPTAX where TAXNUM=:b0           ";
 ...
 static char *sq0004 = 
"INFANTTAXDED,0) ,NVL(ADDBABYTAXDED,0\
) ,NVL(OBSGUARTAXDED,0) ,NVL(NAGIVEAMT_2014,0) ,NVL(NPGIVEAMT_2014,0) ,NVL(NP\
GIVEAMT2_2014,0) ,NVL(NAGIVEDED_2014,0) ,NVL(NPGIVEDED_2014,0) ,NVL(NPGIVEDED\
2_2014,0) ,NVL(HOUSEINTAMT6,0) ,NVL(HOUSEINTAMT7,0) ,NVL(HOUSEINTAMT8,0) ,NVL\
(HOUSEINTAMT9,0) ,NVL(HOUSEINTDED6,0) ,NVL(HOUSEINTDED7,0) ,NVL(HOUSEINTDED8,\
0) ,NVL(HOUSEINTDED9,0) ,NVL(INVESTAMT8,0) ,NVL(INVESTAMT9,0) ,NVL(INVESTAMT1\
0,0) ,NVL(INVESTAMT11,0) ,NVL(INVESTDED4,0) ,NVL(CREDITADDAMT5,0) ,NVL(CREDIT\
ADDAMT6,0) ,NVL(CREDITADDAMT7,0) ,NVL(IHOSAMT,0) ,NVL(RPENAMT,0) ,NVL(RPENDED\
,0) ,NVL(RPENTAXDED,0)  from PKZYSMAS where WorkYY=(select WORKYY  from PKCPB\
AS )           ";

 static char *sq0007 = 
"select SEQ ,YLOANSUM ,YLOANDED  from PKMYSRENT where ((WORKYY=(select worky\
y  from pkcpbas ) and EMPNO=:b0) and NVL(YRENTCOST,0)>0) order by SEQ        \
    ";

 static char *sq0009 = 
"select SEQ ,MRENTCOST ,MRENTCOSTDED  from PKMYSRENT where ((WORKYY=(select \
workyy  from pkcpbas ) and EMPNO=:b0) and NVL(MRENTCOST,0)>0) order by SEQ   \
         ";
...
{12,4274,840,0,0,
5,0,0,1,113,0,9,587,0,0,1,1,0,1,0,1,97,0,0,
24,0,0,1,0,0,13,598,0,0,4,0,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,
55,0,0,1,0,0,15,612,0,0,0,0,0,1,0,
70,0,0,2,2318,0,4,641,0,0,126,0,0,1,0,2,97,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,
...
589,0,0,3,1068,0,5,722,0,0,0,0,0,1,0,
604,0,0,4,2715,0,9,806,0,0,0,0,0,1,0,
619,0,0,4,0,0,13,819,0,0,129,0,0,1,0,2,97,0,0,2,97,0,0,2,4,0,0,2,4,0,0,2,4,0,0,
2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,
0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,
0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,
4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,
...
1150,0,0,4,0,0,15,866,0,0,0,0,0,1,0,
1165,0,0,5,1065,0,4,1377,0,0,10,1,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,
0,2,4,0,0,2,4,0,0,2,4,0,0,2,4,0,0,1,97,0,0,
1220,0,0,6,107,0,5,2804,0,0,1,1,0,1,0,1,97,0,0,
1239,0,0,7,156,0,9,2823,0,0,1,1,0,1,0,1,97,0,0,
1258,0,0,7,0,0,13,2837,0,0,3,0,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,
1285,0,0,7,0,0,15,2849,0,0,0,0,0,1,0,
1300,0,0,8,167,0,5,2856,0,0,4,4,0,1,0,1,4,0,0,1,97,0,0,1,97,0,0,1,4,0,0,
1331,0,0,9,161,0,9,2882,0,0,1,1,0,1,0,1,97,0,0,
1350,0,0,9,0,0,13,2896,0,0,3,0,0,1,0,2,4,0,0,2,4,0,0,2,4,0,0,
1377,0,0,9,0,0,15,2908,0,0,0,0,0,1,0,
1392,0,0,10,171,0,5,2918,0,0,4,4,0,1,0,1,4,0,0,1,97,0,0,1,97,0,0,1,4,0,0,
1423,0,0,11,2008,0,5,2936,0,0,127,127,0,1,0,1,4,0,0,1,4,0,0,1,4,0,0,1,4,0,0,1,
...
0,1,4,0,0,1,4,0,0,1,4,0,0,1,4,0,0,1,4,0,0,1,4,0,0,1,4,0,0,1,4,0,0,1,4,0,0,1,4,
0,0,1,4,0,0,1,4,0,0,1,4,0,0,1,4,0,0,1,4,0,0,1,4,0,0,1,4,0,0,1,4,0,0,1,4,0,0,1,
4,0,0,1,4,0,0,1,4,0,0,1,97,0,0,1,97,0,0,1,97,0,0,
1946,0,0,12,50,0,3,3078,0,0,5,5,0,2,6,76,79,71,95,68,66,1,97,0,0,1,97,0,0,1,3,
0,0,1,97,0,0,1,97,0,0,
1987,0,0,13,0,0,29,3088,0,0,0,0,0,2,6,76,79,71,95,68,66,
};


/*----------------------------------------------------------------------------
 PROGRAM-NAME   : 임원 재직자 연말정산(pkz3010g)
 SYSTEM-NAME    : 급여
 SUBSYSTEM-NAME : 연말정산
 PROGRAMMER     : 강륜종
 VERSION        : 1.00
...
------------------------------------------------------------------------------
   1.00   2008.11      강륜종  pkz1050g를 기반으로 임원 연말정산 프로그램 개발
------------------------------------------------------------------------------
============================================================================= 
★ PKZYSMAS 와 PKZYSHIS 테이블에서는 아래와 같이 사용.
...
char *argv[];
{
     ...
     if (argc != 5) 
     {      /* /hper/insa/HINSA/proc/bin/Kbin/pkz3010g 20150310 D006 pkz3010g 2015031000000 */
            printf("[Usage] : pkz3010g 1.지급일자 2.작업사번 3.프로그램ID 4.시작시간  \n");
            exit(1);
     }
       
     /*로그 디렉토리 생성 및 로그작업 */
     STRINIT(FL_file);
     strcpy(FL_file,"pkz3010g");
...

{
     ...
     sqlstm.sqltdsp = &sqltds;
     sqlbuft((void **)0,
       "select TAXNUM ,INDEDBASIC ,INDEDBRATE ,INDEDORATE ,INDEDORATE2 ,INDE\
DORATE3 ,INDEDORATE4 ,INDEDLIMIT ,INDEDLIMIT2 ,INDEDLIMIT3 ,INDEDLIMIT4 ,BAS\
DED ,APPDED ,FEWDED1 ,FEWDED2 ,STDDED ,INSDEDLIMIT ,MEDDEDLIMIT ,MEDORATE ,K\
INEDULIMIT ,CJKEDULIMIT ,UNIEDULIMIT ,BROEDUNO ,HSRATE ,HSDEDLIMIT ,HSDEDLIM\
IT2 ,HSDEDLIMIT3 ,HSDEDLIMIT4 ,GIVDEDRATE ,GIVDEDRATE2 ,GIVDEDRATE3 ,PENRATE\
 ,PENDEDLIMIT ,NPENDEDLIMIT ,TAXDEDBASIC ,TAXDEDBRATE ,TAXDEDORATE ,TAXDEDLI\
MIT ,PRODEDRATE ,HSINTRATE ,JUTAXRATE ,NONGRATE ,OINVESTRATE ,OINVESTDEDRATE\
 ,INVESTRATE ,INVESTDEDRATE ,CREDEDLIMIT ,CREDEDRATE ,CREORATE ,CREDEDLRATE \
,OBSDEDLIMIT ,APPOLDDED ,APPOLDDED2 ,OBSEDULIMIT ,SPGIVDEDRATE ,DEBITDEDRATE\
 ,GIRODEDRATE ,FOREDEDRATE ,SPECADDLIMIT ,POLILIMIT ,OBSDEDADD ,COSTOCKLIMIT\
 ,APPBABYDED ,FUNDRATE1 ,FUNDRATE2 ,FUNDRATE3 ,LONGMTRATE ,HSDEDLIMIT4 ,INDE\
DBRATE ,GIVDEDRATE3 ,TMARKETDEDRATE ,TMARKETEXLIMIT ,INVESTRATE2 ,INVESTDEDR\
ATE2 ,HSDEDLIMIT5 ,HSDEDLIMIT6 ,SPARENTDEDADD ,HSRATE2 ,TRAFFICDEDRATE ,TRAF\
FICEXLIMIT ,SPDEDLIMIT ,INVESTRATE3 ,HSRENTI");
     sqlbuft((void **)0,
       "NTRATE ,HSRENTINTLIMIT ,NOTICERATE ,TAXDEDSECT1 ,TAXDEDSLIMIT1 ,TAXD\
EDSECT2 ,TAXDEDSLIMIT2 ,APPDEDLIMIT ,NPENRATE ,SPECIALRATE1 ,SPECIALRATE2 ,G\
IVESLIMIT ,GIVESRATE ,HOUSERENTLIMIT1 ,HOUSERENTLIMIT2 ,HOUSERENTRATE ,INVES\
TRATE4 ,INVESTRATE5 ,INVESTRATE6 ,INVESTDEDRATE3 ,LONGFUNDLIMIT1 ,LONGFUNDLI\
MIT2 ,LONGFUNDRATE ,CARDUPRATE1 ,CARDUPRATE2 ,YLOANBASLIMIT ,INFANTDED ,ADDB\
ABYDED ,NPENRATE2 ,NPENLIMIT ,HOUSVLIMIT1 ,HOUSVLIMIT2 ,HOUSVLIMIT3 ,HOUSVLI\
MIT4 ,HSDEDLIMIT7 ,HSDEDLIMIT8 ,HSDEDLIMIT9 ,HSDEDLIMIT10 ,INVESTRATE7 ,INVE\
STRATE8 ,INVESTRATE9 ,INVESTRATE10 ,CARDUPRATE3 ,RPENDEDLIMIT into :b0,:b1,:\
...
49,:b50,:b51,:b52,:b53,:b54,:b55,:b56,:b57,:b58,:b59,:b60,:b61,:b62,:b63,:b6\
4,:b65,:b66,:b27,:b2,:b30,:b70,:b71,:b72,:b73,:b74,:b75,:b76,:b77,:b78,:b79,\
:b80,:b81,:b82,:b83,:b84,:b85,:b86,:b87,:b88");
     sqlstm.stmt = ",:b89,:b90,:b91,:b92,:b93,:b94,:b95,:b96,:b97,:b98,:b99\
,:b100,:b101,:b102,:b103,:b104,:b105,:b106,:b107,:b108,:b109,:b110,:b111,:b11\
2,:b113,:b114,:b115,:b116,:b117,:b118,:b119,:b120,:b121,:b122,:b123,:b124,:b1\
25  from PKCYSBAS where WORKYY=(select WORKYY  from PKCPBAS )";
     sqlstm.iters = (unsigned int  )1;
...
Calc_Yearend()
{
     ...
     /* EXEC SQL
     UPDATE PKZYSMAS   /o우리사주인출 과세액 + Stock Option 과세액 추가 o/
        SET TAXGROSS = NVL(MPAYSUM,0)         + NVL(MBONSUM,0)          + NVL(MGITASODK,0)       + NVL(FORITAXGROSS,0)    +
                       ...
                       NVL(MLIMITOVERSUM,0)   + NVL(BLIMITOVERSUM,0)    + NVL(BLIMITOVERSUM1,0),  /o임원퇴직소득초과금액 2013.11 jissio/ 
...

{
     ...
     sqlstm.sqltdsp = &sqltds;
     sqlbuft((void **)0,
       "update PKZYSMAS  set TAXGROSS=((((((((((((((((((((NVL(MPAYSUM,0)+NVL\
(MBONSUM,0))+NVL(MGITASODK,0))+NVL(FORITAXGROSS,0))+NVL(BPAYSUM,0))+NVL(BBON\
SUM,0))+NVL(BPAYSUM1,0))+NVL(BBONSUM1,0))+NVL(BPAYSUM2,0))+NVL(BBONSUM2,0))+\
NVL(MCOGBONSUM,0))+NVL(BCOGBONSUM,0))+NVL(COSTOCKTAX,0))+NVL(MSTOCKSUM,0))+N\
VL(BCOSTOCKTAX,0))+NVL(BCOSTOCKTAX1,0))+NVL(BMSTOCKTAX,0))+NVL(BMSTOCKTAX1,0\
))+NVL(MLIMITOVERSUM,0))+NVL(BLIMITOVERSUM,0))+NVL(BLIMITOVERSUM1,0)),NOTAX=\
(((((((((((((((((((((((((NVL(MNOTAX,0)+NVL(BNOTAX,0))+NVL(INDEPENDNOTAX,0))+\
NVL(BINDEPENDNOTAX,0))+NVL(BINDEPENDNOTAX1,0))+NVL(OVTMNOTAX,0))+NVL(BOVTMNO\
TAX,0))+NVL(BOVTMNOTAX1,0))+NVL(KEDUNOTAX,0))+NVL(BKEDUNOTAX,0))+NVL(BKEDUNO\
TAX1,0))+NVL(FOREIGNNOTAX,0))+NVL(BFOREIGNNOTAX,0))+NVL(BFOREIGNNOTAX1,0))+N\
VL(COSTOCKNOTAX,0))+NVL(BCOSTOCKNOTAX,0))+NVL(BCOSTOCKNOTAX1,0))+NVL(COSTOCK\
75NOTAX,0))+NVL(BCOSTOCK75NOTAX,0))+NVL(BCOSTOCK75NOTAX1,0))+NVL(COSTOCK50NO\
TAX,0))+NVL(BCOSTOCK50NOTAX,0))+NVL(BCOSTOCK50NOTAX1,0))+NVL(MSTOCKTNOTAX,0)\
)+NVL(BMSTOCKNOTAX,0))+NVL(BMSTOCKNOTAX1,0))");
     sqlstm.stmt = " where WorkYY=(select WORKYY  from PKCPBAS )";
     sqlstm.iters = (unsigned int  )1;
     ...
     */  
     ...
     SELECT  EMPNO,                 REPLACE(NVL(JUMINID,''),'-',''),               NVL(TAXGROSS,0),   NVL(FORITAXGROSS,0),  /o 국외근로소득 o/
...

{
     ...
     sqlstm.sqltdsp = &sqltds;
     sqlbuft((void **)0,
       "select EMPNO ,REPLACE(NVL(JUMINID,''),'-','') ,NVL(TAXGROSS,0) ,NVL(\
FORITAXGROSS,0) ,NVL(MCOGBONSUM,0) ,NVL(BCOGBONSUM,0) ,NVL(MATE,0) ,NVL(FAMI\
LYNO,0) ,NVL(FAMI65NO,0) ,NVL(OBSTACLENO,0) ,NVL(CHILDNO,0) ,NVL(WOMAN,0) ,N\
VL(ANUAMT,0) ,((NVL(BANUAMT,0)+NVL(BANUAMT1,0))+NVL(BANUAMT2,0)) BANUAMT ,NV\
L(MEDAMT,0) ,((NVL(BMEDAMT,0)+NVL(BMEDAMT1,0))+NVL(BMEDAMT2,0)) BMEDAMT ,NVL\
(HIREAMT,0) ,((NVL(BHIREAMT,0)+NVL(BHIREAMT1,0))+NVL(BHIREAMT2,0)) BHIREAMT \
,NVL(GUARAMT,0) ,NVL(GHOSAMT,0) ,NVL(OHOSAMT,0) ,NVL(NHOSAMT,0) ,NVL(KEDUNO,\
0) ,NVL(UEDUNO,0) ,NVL(SEDUAMT,0) ,NVL(KEDUAMT,0) ,NVL(CEDUNO,0) ,NVL(CEDUAM\
T,0) ,NVL(UEDUAMT,0) ,NVL(HOUSEAMT,0) ,NVL(HOUSEAMT2,0) ,NVL(AGIVEAMT,0) ,NV\
L(PGIVEAMT,0) ,NVL(PGIVEAMT2,0) ,NVL(SGIVEAMT,0) ,NVL(PENAMT1,0) ,NVL(PENAMT\
2,0) ,NVL(HLOANAMT,0) ,NVL(FORIAMT,0) ,NVL(ETCTAMT,0) ,NVL(MINTAX,0) ,NVL(MJ\
UTAX,0) ,NVL(MNONGTAX,0) ,((NVL(BINTAX,0)+NVL(BINTAX1,0))+NVL(BINTAX2,0)) BI\
NTAX ,((NVL(BJUTAX,0)+NVL(BJUTAX1,0))+NVL(BJUTAX2,0)) BJUTAX ,((NVL(BNONGTAX\
,0)+NVL(BNONGTAX1,0))+NVL(BNONGTAX2,0)) BNON");
     sqlbuft((void **)0,
       "GTAX ,NVL(KEDUNO1,0) ,NVL(KEDUAMT1,0) ,NVL(INVESTAMT,0) ,NVL(CREDITT\
OTAMT,0) ,NVL(CREDITDEDAMT,0) ,NVL(CREDITAMT,0) ,NVL(OBSGUARAMT,0) ,NVL(NPEN\
AMT,0) ,NVL(NPENAMT2,0) ,NVL(OBSEDUAMT,0) ,NVL(SPGIVAMT,0) ,NVL(OBSEDUNO,0) \
,NVL(DEBITAMT,0) ,NVL(GIROAMT,0) ,NVL(POLIAMT,0) ,NVL(FAMI70NO,0) ,NVL(SPECA\
DDNO,0) ,NVL(SPECADDDED,0) ,NVL(SHOSAMT,0) ,NVL(HOUSEINTAMT,0) ,NVL(HOUSEINT\
AMT2,0) ,NVL(HOUSEINTAMT3,0) ,NVL(CASHAMT,0) ,NVL(COSTOCKAMT,0) ,NVL(FEWNO,0\
) ,NVL(BABYNO,0) ,NVL(FUNDAMT1,0) ,NVL(FUNDAMT2,0) ,NVL(FUNDAMT3,0) ,NVL(LON\
GMTAMT,0) ,NVL(houserentamt,0) ,NVL(housvsubamt,0) ,NVL(housvcomamt,0) ,NVL(\
housvempamt,0) ,NVL(HOUSEAMT3,0) ,NVL(TMARKETAMT,0) ,NVL(HOUSEINTAMT4,0) ,NV\
L(HOUSEINTAMT5,0) ,NVL(INVESTAMT2,0) ,NVL(SPARENT,0) ,NVL(TRAFFICAMT,0) ,NVL\
(INVESTAMT3,0) ,NVL(INVESTAMT4,0) ,NVL(HSRENTINAMT,0) ,NVL(INVESTAMT5,0) ,NV\
L(INVESTAMT6,0) ,NVL(INVESTAMT7,0) ,NVL(LONGFUNDAMT,0) ,NVL(CREDITADDAMT1,0)\
 ,NVL(CREDITADDAMT2,0) ,NVL(CREDITADDAMT3,0) ,NVL(CREDITADDAMT4,0) ,NVL(NPGI\
VEAMT2_2010,0) ,NVL(NPGIVEAMT2_ELSE,0) ,NVL(");
     sqlstm.stmt = sq0004;
     sqlstm.iters = (unsigned int  )1;
     ...
     while(1)
     {
          ...
          :empno,          :juminid,        :taxgross,       :foritaxgross,  /o 국외근로소득 o/
...

{
          ...
          sqlstm.sqadto[2] = (unsigned short )0;
          sqlstm.sqtdso[2] = (unsigned short )0;
          sqlstm.sqhstv[3] = (unsigned char  *)&foritaxgross;
          sqlstm.sqhstl[3] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[3] = (         int  )0;
          sqlstm.sqindv[3] = (         short *)0;
          sqlstm.sqinds[3] = (         int  )0;
          ...
          sqlstm.sqadto[3] = (unsigned short )0;
          sqlstm.sqtdso[3] = (unsigned short )0;
          sqlstm.sqhstv[4] = (unsigned char  *)&mcogbonsum;
          sqlstm.sqhstl[4] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[4] = (         int  )0;
          sqlstm.sqindv[4] = (         short *)0;
          sqlstm.sqinds[4] = (         int  )0;
          ...
          sqlstm.sqadto[4] = (unsigned short )0;
          sqlstm.sqtdso[4] = (unsigned short )0;
          sqlstm.sqhstv[5] = (unsigned char  *)&bcogbonsum;
          sqlstm.sqhstl[5] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[5] = (         int  )0;
          sqlstm.sqindv[5] = (         short *)0;
          sqlstm.sqinds[5] = (         int  )0;
          ...
          sqlstm.sqadto[5] = (unsigned short )0;
          sqlstm.sqtdso[5] = (unsigned short )0;
          sqlstm.sqhstv[6] = (unsigned char  *)&mate;
          sqlstm.sqhstl[6] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[6] = (         int  )0;
          sqlstm.sqindv[6] = (         short *)0;
          sqlstm.sqinds[6] = (         int  )0;
          ...
          sqlstm.sqadto[6] = (unsigned short )0;
          sqlstm.sqtdso[6] = (unsigned short )0;
          sqlstm.sqhstv[7] = (unsigned char  *)&familyno;
          sqlstm.sqhstl[7] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[7] = (         int  )0;
          sqlstm.sqindv[7] = (         short *)0;
          sqlstm.sqinds[7] = (         int  )0;
          ...
          sqlstm.sqadto[7] = (unsigned short )0;
          sqlstm.sqtdso[7] = (unsigned short )0;
          sqlstm.sqhstv[8] = (unsigned char  *)&fami65no;
          sqlstm.sqhstl[8] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[8] = (         int  )0;
          sqlstm.sqindv[8] = (         short *)0;
          sqlstm.sqinds[8] = (         int  )0;
          ...
          sqlstm.sqadto[8] = (unsigned short )0;
          sqlstm.sqtdso[8] = (unsigned short )0;
          sqlstm.sqhstv[9] = (unsigned char  *)&obstacleno;
          sqlstm.sqhstl[9] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[9] = (         int  )0;
          sqlstm.sqindv[9] = (         short *)0;
          sqlstm.sqinds[9] = (         int  )0;
          ...
          sqlstm.sqadto[9] = (unsigned short )0;
          sqlstm.sqtdso[9] = (unsigned short )0;
          sqlstm.sqhstv[10] = (unsigned char  *)&childno;
          sqlstm.sqhstl[10] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[10] = (         int  )0;
          sqlstm.sqindv[10] = (         short *)0;
          sqlstm.sqinds[10] = (         int  )0;
          ...
          sqlstm.sqadto[10] = (unsigned short )0;
          sqlstm.sqtdso[10] = (unsigned short )0;
          sqlstm.sqhstv[11] = (unsigned char  *)&woman;
          sqlstm.sqhstl[11] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[11] = (         int  )0;
          sqlstm.sqindv[11] = (         short *)0;
          sqlstm.sqinds[11] = (         int  )0;
          ...
          sqlstm.sqadto[11] = (unsigned short )0;
          sqlstm.sqtdso[11] = (unsigned short )0;
          sqlstm.sqhstv[12] = (unsigned char  *)&anuamt;
          sqlstm.sqhstl[12] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[12] = (         int  )0;
          sqlstm.sqindv[12] = (         short *)0;
          sqlstm.sqinds[12] = (         int  )0;
          ...
          sqlstm.sqadto[12] = (unsigned short )0;
          sqlstm.sqtdso[12] = (unsigned short )0;
          sqlstm.sqhstv[13] = (unsigned char  *)&banuamt;
          sqlstm.sqhstl[13] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[13] = (         int  )0;
          sqlstm.sqindv[13] = (         short *)0;
          sqlstm.sqinds[13] = (         int  )0;
          ...
          sqlstm.sqadto[13] = (unsigned short )0;
          sqlstm.sqtdso[13] = (unsigned short )0;
          sqlstm.sqhstv[14] = (unsigned char  *)&medamt;
          sqlstm.sqhstl[14] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[14] = (         int  )0;
          sqlstm.sqindv[14] = (         short *)0;
          sqlstm.sqinds[14] = (         int  )0;
          ...
          sqlstm.sqadto[14] = (unsigned short )0;
          sqlstm.sqtdso[14] = (unsigned short )0;
          sqlstm.sqhstv[15] = (unsigned char  *)&bmedamt;
          sqlstm.sqhstl[15] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[15] = (         int  )0;
          sqlstm.sqindv[15] = (         short *)0;
          sqlstm.sqinds[15] = (         int  )0;
          ...
          sqlstm.sqadto[15] = (unsigned short )0;
          sqlstm.sqtdso[15] = (unsigned short )0;
          sqlstm.sqhstv[16] = (unsigned char  *)&hireamt;
          sqlstm.sqhstl[16] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[16] = (         int  )0;
          sqlstm.sqindv[16] = (         short *)0;
          sqlstm.sqinds[16] = (         int  )0;
          ...
          sqlstm.sqadto[16] = (unsigned short )0;
          sqlstm.sqtdso[16] = (unsigned short )0;
          sqlstm.sqhstv[17] = (unsigned char  *)&bhireamt;
          sqlstm.sqhstl[17] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[17] = (         int  )0;
          sqlstm.sqindv[17] = (         short *)0;
          sqlstm.sqinds[17] = (         int  )0;
          ...
          sqlstm.sqadto[17] = (unsigned short )0;
          sqlstm.sqtdso[17] = (unsigned short )0;
          sqlstm.sqhstv[18] = (unsigned char  *)&guaramt;
          sqlstm.sqhstl[18] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[18] = (         int  )0;
          sqlstm.sqindv[18] = (         short *)0;
          sqlstm.sqinds[18] = (         int  )0;
          ...
          sqlstm.sqadto[18] = (unsigned short )0;
          sqlstm.sqtdso[18] = (unsigned short )0;
          sqlstm.sqhstv[19] = (unsigned char  *)&ghosamt;
          sqlstm.sqhstl[19] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[19] = (         int  )0;
          sqlstm.sqindv[19] = (         short *)0;
          sqlstm.sqinds[19] = (         int  )0;
          ...
          sqlstm.sqadto[19] = (unsigned short )0;
          sqlstm.sqtdso[19] = (unsigned short )0;
          sqlstm.sqhstv[20] = (unsigned char  *)&ohosamt;
          sqlstm.sqhstl[20] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[20] = (         int  )0;
          sqlstm.sqindv[20] = (         short *)0;
          sqlstm.sqinds[20] = (         int  )0;
          ...
          sqlstm.sqadto[20] = (unsigned short )0;
          sqlstm.sqtdso[20] = (unsigned short )0;
          sqlstm.sqhstv[21] = (unsigned char  *)&nhosamt;
          sqlstm.sqhstl[21] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[21] = (         int  )0;
          sqlstm.sqindv[21] = (         short *)0;
          sqlstm.sqinds[21] = (         int  )0;
          ...
          sqlstm.sqadto[21] = (unsigned short )0;
          sqlstm.sqtdso[21] = (unsigned short )0;
          sqlstm.sqhstv[22] = (unsigned char  *)&keduno;
          sqlstm.sqhstl[22] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[22] = (         int  )0;
          sqlstm.sqindv[22] = (         short *)0;
          sqlstm.sqinds[22] = (         int  )0;
          ...
          sqlstm.sqadto[22] = (unsigned short )0;
          sqlstm.sqtdso[22] = (unsigned short )0;
          sqlstm.sqhstv[23] = (unsigned char  *)&ueduno;
          sqlstm.sqhstl[23] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[23] = (         int  )0;
          sqlstm.sqindv[23] = (         short *)0;
          sqlstm.sqinds[23] = (         int  )0;
          ...
          sqlstm.sqadto[23] = (unsigned short )0;
          sqlstm.sqtdso[23] = (unsigned short )0;
          sqlstm.sqhstv[24] = (unsigned char  *)&seduamt;
          sqlstm.sqhstl[24] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[24] = (         int  )0;
          sqlstm.sqindv[24] = (         short *)0;
          sqlstm.sqinds[24] = (         int  )0;
          ...
          sqlstm.sqadto[24] = (unsigned short )0;
          sqlstm.sqtdso[24] = (unsigned short )0;
          sqlstm.sqhstv[25] = (unsigned char  *)&keduamt;
          sqlstm.sqhstl[25] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[25] = (         int  )0;
          sqlstm.sqindv[25] = (         short *)0;
          sqlstm.sqinds[25] = (         int  )0;
          ...
          sqlstm.sqadto[25] = (unsigned short )0;
          sqlstm.sqtdso[25] = (unsigned short )0;
          sqlstm.sqhstv[26] = (unsigned char  *)&ceduno;
          sqlstm.sqhstl[26] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[26] = (         int  )0;
          sqlstm.sqindv[26] = (         short *)0;
          sqlstm.sqinds[26] = (         int  )0;
          ...
          sqlstm.sqadto[26] = (unsigned short )0;
          sqlstm.sqtdso[26] = (unsigned short )0;
          sqlstm.sqhstv[27] = (unsigned char  *)&ceduamt;
          sqlstm.sqhstl[27] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[27] = (         int  )0;
          sqlstm.sqindv[27] = (         short *)0;
          sqlstm.sqinds[27] = (         int  )0;
          ...
          sqlstm.sqadto[27] = (unsigned short )0;
          sqlstm.sqtdso[27] = (unsigned short )0;
          sqlstm.sqhstv[28] = (unsigned char  *)&ueduamt;
          sqlstm.sqhstl[28] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[28] = (         int  )0;
          sqlstm.sqindv[28] = (         short *)0;
          sqlstm.sqinds[28] = (         int  )0;
          ...
          sqlstm.sqadto[28] = (unsigned short )0;
          sqlstm.sqtdso[28] = (unsigned short )0;
          sqlstm.sqhstv[29] = (unsigned char  *)&houseamt;
          sqlstm.sqhstl[29] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[29] = (         int  )0;
          sqlstm.sqindv[29] = (         short *)0;
          sqlstm.sqinds[29] = (         int  )0;
          ...
          sqlstm.sqadto[29] = (unsigned short )0;
          sqlstm.sqtdso[29] = (unsigned short )0;
          sqlstm.sqhstv[30] = (unsigned char  *)&houseamt2;
          sqlstm.sqhstl[30] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[30] = (         int  )0;
          sqlstm.sqindv[30] = (         short *)0;
          sqlstm.sqinds[30] = (         int  )0;
          ...
          sqlstm.sqadto[30] = (unsigned short )0;
          sqlstm.sqtdso[30] = (unsigned short )0;
          sqlstm.sqhstv[31] = (unsigned char  *)&agiveamt;
          sqlstm.sqhstl[31] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[31] = (         int  )0;
          sqlstm.sqindv[31] = (         short *)0;
          sqlstm.sqinds[31] = (         int  )0;
          ...
          sqlstm.sqadto[31] = (unsigned short )0;
          sqlstm.sqtdso[31] = (unsigned short )0;
          sqlstm.sqhstv[32] = (unsigned char  *)&pgiveamt;
          sqlstm.sqhstl[32] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[32] = (         int  )0;
          sqlstm.sqindv[32] = (         short *)0;
          sqlstm.sqinds[32] = (         int  )0;
          ...
          sqlstm.sqadto[32] = (unsigned short )0;
          sqlstm.sqtdso[32] = (unsigned short )0;
          sqlstm.sqhstv[33] = (unsigned char  *)&pgiveamt2;
          sqlstm.sqhstl[33] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[33] = (         int  )0;
          sqlstm.sqindv[33] = (         short *)0;
          sqlstm.sqinds[33] = (         int  )0;
          ...
          sqlstm.sqadto[33] = (unsigned short )0;
          sqlstm.sqtdso[33] = (unsigned short )0;
          sqlstm.sqhstv[34] = (unsigned char  *)&sgiveamt;
          sqlstm.sqhstl[34] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[34] = (         int  )0;
          sqlstm.sqindv[34] = (         short *)0;
          sqlstm.sqinds[34] = (         int  )0;
          ...
          sqlstm.sqadto[34] = (unsigned short )0;
          sqlstm.sqtdso[34] = (unsigned short )0;
          sqlstm.sqhstv[35] = (unsigned char  *)&penamt1;
          sqlstm.sqhstl[35] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[35] = (         int  )0;
          sqlstm.sqindv[35] = (         short *)0;
          sqlstm.sqinds[35] = (         int  )0;
          ...
          sqlstm.sqadto[35] = (unsigned short )0;
          sqlstm.sqtdso[35] = (unsigned short )0;
          sqlstm.sqhstv[36] = (unsigned char  *)&penamt2;
          sqlstm.sqhstl[36] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[36] = (         int  )0;
          sqlstm.sqindv[36] = (         short *)0;
          sqlstm.sqinds[36] = (         int  )0;
          ...
          sqlstm.sqadto[41] = (unsigned short )0;
          sqlstm.sqtdso[41] = (unsigned short )0;
          sqlstm.sqhstv[42] = (unsigned char  *)&mnongtax;
          sqlstm.sqhstl[42] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[42] = (         int  )0;
          sqlstm.sqindv[42] = (         short *)0;
          sqlstm.sqinds[42] = (         int  )0;
          ...
          sqlstm.sqadto[45] = (unsigned short )0;
          sqlstm.sqtdso[45] = (unsigned short )0;
          sqlstm.sqhstv[46] = (unsigned char  *)&keduno1;
          sqlstm.sqhstl[46] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[46] = (         int  )0;
          sqlstm.sqindv[46] = (         short *)0;
          sqlstm.sqinds[46] = (         int  )0;
          ...
          sqlstm.sqadto[46] = (unsigned short )0;
          sqlstm.sqtdso[46] = (unsigned short )0;
          sqlstm.sqhstv[47] = (unsigned char  *)&keduamt1;
          sqlstm.sqhstl[47] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[47] = (         int  )0;
          sqlstm.sqindv[47] = (         short *)0;
          sqlstm.sqinds[47] = (         int  )0;
          ...
          sqlstm.sqadto[48] = (unsigned short )0;
          sqlstm.sqtdso[48] = (unsigned short )0;
          sqlstm.sqhstv[49] = (unsigned char  *)&credittotamt;
          sqlstm.sqhstl[49] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[49] = (         int  )0;
          sqlstm.sqindv[49] = (         short *)0;
          sqlstm.sqinds[49] = (         int  )0;
          ...
          sqlstm.sqadto[49] = (unsigned short )0;
          sqlstm.sqtdso[49] = (unsigned short )0;
          sqlstm.sqhstv[50] = (unsigned char  *)&creditdedamt;
          sqlstm.sqhstl[50] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[50] = (         int  )0;
          sqlstm.sqindv[50] = (         short *)0;
          sqlstm.sqinds[50] = (         int  )0;
          ...
          sqlstm.sqadto[50] = (unsigned short )0;
          sqlstm.sqtdso[50] = (unsigned short )0;
          sqlstm.sqhstv[51] = (unsigned char  *)&creditamt;
          sqlstm.sqhstl[51] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[51] = (         int  )0;
          sqlstm.sqindv[51] = (         short *)0;
          sqlstm.sqinds[51] = (         int  )0;
          ...
          sqlstm.sqadto[51] = (unsigned short )0;
          sqlstm.sqtdso[51] = (unsigned short )0;
          sqlstm.sqhstv[52] = (unsigned char  *)&obsguaramt;
          sqlstm.sqhstl[52] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[52] = (         int  )0;
          sqlstm.sqindv[52] = (         short *)0;
          sqlstm.sqinds[52] = (         int  )0;
          ...
          sqlstm.sqadto[52] = (unsigned short )0;
          sqlstm.sqtdso[52] = (unsigned short )0;
          sqlstm.sqhstv[53] = (unsigned char  *)&npenamt;
          sqlstm.sqhstl[53] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[53] = (         int  )0;
          sqlstm.sqindv[53] = (         short *)0;
          sqlstm.sqinds[53] = (         int  )0;
          ...
          sqlstm.sqadto[53] = (unsigned short )0;
          sqlstm.sqtdso[53] = (unsigned short )0;
          sqlstm.sqhstv[54] = (unsigned char  *)&npenamt2;
          sqlstm.sqhstl[54] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[54] = (         int  )0;
          sqlstm.sqindv[54] = (         short *)0;
          sqlstm.sqinds[54] = (         int  )0;
          ...
          sqlstm.sqadto[54] = (unsigned short )0;
          sqlstm.sqtdso[54] = (unsigned short )0;
          sqlstm.sqhstv[55] = (unsigned char  *)&obseduamt;
          sqlstm.sqhstl[55] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[55] = (         int  )0;
          sqlstm.sqindv[55] = (         short *)0;
          sqlstm.sqinds[55] = (         int  )0;
          ...
          sqlstm.sqadto[55] = (unsigned short )0;
          sqlstm.sqtdso[55] = (unsigned short )0;
          sqlstm.sqhstv[56] = (unsigned char  *)&spgivamt;
          sqlstm.sqhstl[56] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[56] = (         int  )0;
          sqlstm.sqindv[56] = (         short *)0;
          sqlstm.sqinds[56] = (         int  )0;
          ...
          sqlstm.sqadto[56] = (unsigned short )0;
          sqlstm.sqtdso[56] = (unsigned short )0;
          sqlstm.sqhstv[57] = (unsigned char  *)&obseduno;
          sqlstm.sqhstl[57] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[57] = (         int  )0;
          sqlstm.sqindv[57] = (         short *)0;
          sqlstm.sqinds[57] = (         int  )0;
          ...
          sqlstm.sqadto[57] = (unsigned short )0;
          sqlstm.sqtdso[57] = (unsigned short )0;
          sqlstm.sqhstv[58] = (unsigned char  *)&debitamt;
          sqlstm.sqhstl[58] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[58] = (         int  )0;
          sqlstm.sqindv[58] = (         short *)0;
          sqlstm.sqinds[58] = (         int  )0;
          ...
          sqlstm.sqadto[58] = (unsigned short )0;
          sqlstm.sqtdso[58] = (unsigned short )0;
          sqlstm.sqhstv[59] = (unsigned char  *)&giroamt;
          sqlstm.sqhstl[59] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[59] = (         int  )0;
          sqlstm.sqindv[59] = (         short *)0;
          sqlstm.sqinds[59] = (         int  )0;
          ...
          sqlstm.sqadto[59] = (unsigned short )0;
          sqlstm.sqtdso[59] = (unsigned short )0;
          sqlstm.sqhstv[60] = (unsigned char  *)&poliamt;
          sqlstm.sqhstl[60] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[60] = (         int  )0;
          sqlstm.sqindv[60] = (         short *)0;
          sqlstm.sqinds[60] = (         int  )0;
          ...
          sqlstm.sqadto[60] = (unsigned short )0;
          sqlstm.sqtdso[60] = (unsigned short )0;
          sqlstm.sqhstv[61] = (unsigned char  *)&fami70no;
          sqlstm.sqhstl[61] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[61] = (         int  )0;
          sqlstm.sqindv[61] = (         short *)0;
          sqlstm.sqinds[61] = (         int  )0;
          ...
          sqlstm.sqadto[61] = (unsigned short )0;
          sqlstm.sqtdso[61] = (unsigned short )0;
          sqlstm.sqhstv[62] = (unsigned char  *)&specaddno;
          sqlstm.sqhstl[62] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[62] = (         int  )0;
          sqlstm.sqindv[62] = (         short *)0;
          sqlstm.sqinds[62] = (         int  )0;
          ...
          sqlstm.sqadto[62] = (unsigned short )0;
          sqlstm.sqtdso[62] = (unsigned short )0;
          sqlstm.sqhstv[63] = (unsigned char  *)&specaddded;
          sqlstm.sqhstl[63] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[63] = (         int  )0;
          sqlstm.sqindv[63] = (         short *)0;
          sqlstm.sqinds[63] = (         int  )0;
          ...
          sqlstm.sqadto[63] = (unsigned short )0;
          sqlstm.sqtdso[63] = (unsigned short )0;
          sqlstm.sqhstv[64] = (unsigned char  *)&shosamt;
          sqlstm.sqhstl[64] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[64] = (         int  )0;
          sqlstm.sqindv[64] = (         short *)0;
          sqlstm.sqinds[64] = (         int  )0;
          ...
          sqlstm.sqadto[64] = (unsigned short )0;
          sqlstm.sqtdso[64] = (unsigned short )0;
          sqlstm.sqhstv[65] = (unsigned char  *)&houseintamt;
          sqlstm.sqhstl[65] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[65] = (         int  )0;
          sqlstm.sqindv[65] = (         short *)0;
          sqlstm.sqinds[65] = (         int  )0;
          ...
          sqlstm.sqadto[65] = (unsigned short )0;
          sqlstm.sqtdso[65] = (unsigned short )0;
          sqlstm.sqhstv[66] = (unsigned char  *)&houseintamt2;
          sqlstm.sqhstl[66] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[66] = (         int  )0;
          sqlstm.sqindv[66] = (         short *)0;
          sqlstm.sqinds[66] = (         int  )0;
          ...
          sqlstm.sqadto[66] = (unsigned short )0;
          sqlstm.sqtdso[66] = (unsigned short )0;
          sqlstm.sqhstv[67] = (unsigned char  *)&houseintamt3;
          sqlstm.sqhstl[67] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[67] = (         int  )0;
          sqlstm.sqindv[67] = (         short *)0;
          sqlstm.sqinds[67] = (         int  )0;
          ...
          sqlstm.sqadto[67] = (unsigned short )0;
          sqlstm.sqtdso[67] = (unsigned short )0;
          sqlstm.sqhstv[68] = (unsigned char  *)&cashamt;
          sqlstm.sqhstl[68] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[68] = (         int  )0;
          sqlstm.sqindv[68] = (         short *)0;
          sqlstm.sqinds[68] = (         int  )0;
          ...
          sqlstm.sqadto[68] = (unsigned short )0;
          sqlstm.sqtdso[68] = (unsigned short )0;
          sqlstm.sqhstv[69] = (unsigned char  *)&costockamt;
          sqlstm.sqhstl[69] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[69] = (         int  )0;
          sqlstm.sqindv[69] = (         short *)0;
          sqlstm.sqinds[69] = (         int  )0;
          ...
          sqlstm.sqadto[69] = (unsigned short )0;
          sqlstm.sqtdso[69] = (unsigned short )0;
          sqlstm.sqhstv[70] = (unsigned char  *)&fewno;
          sqlstm.sqhstl[70] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[70] = (         int  )0;
          sqlstm.sqindv[70] = (         short *)0;
          sqlstm.sqinds[70] = (         int  )0;
          ...
          sqlstm.sqadto[70] = (unsigned short )0;
          sqlstm.sqtdso[70] = (unsigned short )0;
          sqlstm.sqhstv[71] = (unsigned char  *)&babyno;
          sqlstm.sqhstl[71] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[71] = (         int  )0;
          sqlstm.sqindv[71] = (         short *)0;
          sqlstm.sqinds[71] = (         int  )0;
          ...
          sqlstm.sqadto[71] = (unsigned short )0;
          sqlstm.sqtdso[71] = (unsigned short )0;
          sqlstm.sqhstv[72] = (unsigned char  *)&fundamt1;
          sqlstm.sqhstl[72] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[72] = (         int  )0;
          sqlstm.sqindv[72] = (         short *)0;
          sqlstm.sqinds[72] = (         int  )0;
          ...
          sqlstm.sqadto[72] = (unsigned short )0;
          sqlstm.sqtdso[72] = (unsigned short )0;
          sqlstm.sqhstv[73] = (unsigned char  *)&fundamt2;
          sqlstm.sqhstl[73] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[73] = (         int  )0;
          sqlstm.sqindv[73] = (         short *)0;
          sqlstm.sqinds[73] = (         int  )0;
          ...
          sqlstm.sqadto[73] = (unsigned short )0;
          sqlstm.sqtdso[73] = (unsigned short )0;
          sqlstm.sqhstv[74] = (unsigned char  *)&fundamt3;
          sqlstm.sqhstl[74] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[74] = (         int  )0;
          sqlstm.sqindv[74] = (         short *)0;
          sqlstm.sqinds[74] = (         int  )0;
          ...
          sqlstm.sqadto[74] = (unsigned short )0;
          sqlstm.sqtdso[74] = (unsigned short )0;
          sqlstm.sqhstv[75] = (unsigned char  *)&longmtamt;
          sqlstm.sqhstl[75] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[75] = (         int  )0;
          sqlstm.sqindv[75] = (         short *)0;
          sqlstm.sqinds[75] = (         int  )0;
          ...
          sqlstm.sqadto[75] = (unsigned short )0;
          sqlstm.sqtdso[75] = (unsigned short )0;
          sqlstm.sqhstv[76] = (unsigned char  *)&houserentamt;
          sqlstm.sqhstl[76] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[76] = (         int  )0;
          sqlstm.sqindv[76] = (         short *)0;
          sqlstm.sqinds[76] = (         int  )0;
          ...
          sqlstm.sqadto[76] = (unsigned short )0;
          sqlstm.sqtdso[76] = (unsigned short )0;
          sqlstm.sqhstv[77] = (unsigned char  *)&housvsubamt;
          sqlstm.sqhstl[77] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[77] = (         int  )0;
          sqlstm.sqindv[77] = (         short *)0;
          sqlstm.sqinds[77] = (         int  )0;
          ...
          sqlstm.sqadto[77] = (unsigned short )0;
          sqlstm.sqtdso[77] = (unsigned short )0;
          sqlstm.sqhstv[78] = (unsigned char  *)&housvcomamt;
          sqlstm.sqhstl[78] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[78] = (         int  )0;
          sqlstm.sqindv[78] = (         short *)0;
          sqlstm.sqinds[78] = (         int  )0;
          ...
          sqlstm.sqadto[78] = (unsigned short )0;
          sqlstm.sqtdso[78] = (unsigned short )0;
          sqlstm.sqhstv[79] = (unsigned char  *)&housvempamt;
          sqlstm.sqhstl[79] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[79] = (         int  )0;
          sqlstm.sqindv[79] = (         short *)0;
          sqlstm.sqinds[79] = (         int  )0;
          ...
          sqlstm.sqadto[79] = (unsigned short )0;
          sqlstm.sqtdso[79] = (unsigned short )0;
          sqlstm.sqhstv[80] = (unsigned char  *)&houseamt3;
          sqlstm.sqhstl[80] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[80] = (         int  )0;
          sqlstm.sqindv[80] = (         short *)0;
          sqlstm.sqinds[80] = (         int  )0;
          ...
          sqlstm.sqadto[80] = (unsigned short )0;
          sqlstm.sqtdso[80] = (unsigned short )0;
          sqlstm.sqhstv[81] = (unsigned char  *)&tmarketamt;
          sqlstm.sqhstl[81] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[81] = (         int  )0;
          sqlstm.sqindv[81] = (         short *)0;
          sqlstm.sqinds[81] = (         int  )0;
          ...
          sqlstm.sqadto[81] = (unsigned short )0;
          sqlstm.sqtdso[81] = (unsigned short )0;
          sqlstm.sqhstv[82] = (unsigned char  *)&houseintamt4;
          sqlstm.sqhstl[82] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[82] = (         int  )0;
          sqlstm.sqindv[82] = (         short *)0;
          sqlstm.sqinds[82] = (         int  )0;
          ...
          sqlstm.sqadto[82] = (unsigned short )0;
          sqlstm.sqtdso[82] = (unsigned short )0;
          sqlstm.sqhstv[83] = (unsigned char  *)&houseintamt5;
          sqlstm.sqhstl[83] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[83] = (         int  )0;
          sqlstm.sqindv[83] = (         short *)0;
          sqlstm.sqinds[83] = (         int  )0;
          ...
          sqlstm.sqadto[83] = (unsigned short )0;
          sqlstm.sqtdso[83] = (unsigned short )0;
          sqlstm.sqhstv[84] = (unsigned char  *)&investamt2;
          sqlstm.sqhstl[84] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[84] = (         int  )0;
          sqlstm.sqindv[84] = (         short *)0;
          sqlstm.sqinds[84] = (         int  )0;
          ...
          sqlstm.sqadto[84] = (unsigned short )0;
          sqlstm.sqtdso[84] = (unsigned short )0;
          sqlstm.sqhstv[85] = (unsigned char  *)&sparent;
          sqlstm.sqhstl[85] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[85] = (         int  )0;
          sqlstm.sqindv[85] = (         short *)0;
          sqlstm.sqinds[85] = (         int  )0;
          ...
          sqlstm.sqadto[85] = (unsigned short )0;
          sqlstm.sqtdso[85] = (unsigned short )0;
          sqlstm.sqhstv[86] = (unsigned char  *)&trafficamt;
          sqlstm.sqhstl[86] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[86] = (         int  )0;
          sqlstm.sqindv[86] = (         short *)0;
          sqlstm.sqinds[86] = (         int  )0;
          ...
          sqlstm.sqadto[86] = (unsigned short )0;
          sqlstm.sqtdso[86] = (unsigned short )0;
          sqlstm.sqhstv[87] = (unsigned char  *)&investamt3;
          sqlstm.sqhstl[87] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[87] = (         int  )0;
          sqlstm.sqindv[87] = (         short *)0;
          sqlstm.sqinds[87] = (         int  )0;
          ...
          sqlstm.sqadto[87] = (unsigned short )0;
          sqlstm.sqtdso[87] = (unsigned short )0;
          sqlstm.sqhstv[88] = (unsigned char  *)&investamt4;
          sqlstm.sqhstl[88] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[88] = (         int  )0;
          sqlstm.sqindv[88] = (         short *)0;
          sqlstm.sqinds[88] = (         int  )0;
          ...
          sqlstm.sqadto[88] = (unsigned short )0;
          sqlstm.sqtdso[88] = (unsigned short )0;
          sqlstm.sqhstv[89] = (unsigned char  *)&hsrentinamt;
          sqlstm.sqhstl[89] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[89] = (         int  )0;
          sqlstm.sqindv[89] = (         short *)0;
          sqlstm.sqinds[89] = (         int  )0;
          ...
          sqlstm.sqadto[89] = (unsigned short )0;
          sqlstm.sqtdso[89] = (unsigned short )0;
          sqlstm.sqhstv[90] = (unsigned char  *)&investamt5;
          sqlstm.sqhstl[90] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[90] = (         int  )0;
          sqlstm.sqindv[90] = (         short *)0;
          sqlstm.sqinds[90] = (         int  )0;
          ...
          sqlstm.sqadto[90] = (unsigned short )0;
          sqlstm.sqtdso[90] = (unsigned short )0;
          sqlstm.sqhstv[91] = (unsigned char  *)&investamt6;
          sqlstm.sqhstl[91] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[91] = (         int  )0;
          sqlstm.sqindv[91] = (         short *)0;
          sqlstm.sqinds[91] = (         int  )0;
          ...
          sqlstm.sqadto[91] = (unsigned short )0;
          sqlstm.sqtdso[91] = (unsigned short )0;
          sqlstm.sqhstv[92] = (unsigned char  *)&investamt7;
          sqlstm.sqhstl[92] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[92] = (         int  )0;
          sqlstm.sqindv[92] = (         short *)0;
          sqlstm.sqinds[92] = (         int  )0;
          ...
          sqlstm.sqadto[92] = (unsigned short )0;
          sqlstm.sqtdso[92] = (unsigned short )0;
          sqlstm.sqhstv[93] = (unsigned char  *)&longfundamt;
          sqlstm.sqhstl[93] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[93] = (         int  )0;
          sqlstm.sqindv[93] = (         short *)0;
          sqlstm.sqinds[93] = (         int  )0;
          ...
          sqlstm.sqadto[93] = (unsigned short )0;
          sqlstm.sqtdso[93] = (unsigned short )0;
          sqlstm.sqhstv[94] = (unsigned char  *)&creditaddamt1;
          sqlstm.sqhstl[94] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[94] = (         int  )0;
          sqlstm.sqindv[94] = (         short *)0;
          sqlstm.sqinds[94] = (         int  )0;
          ...
          sqlstm.sqadto[94] = (unsigned short )0;
          sqlstm.sqtdso[94] = (unsigned short )0;
          sqlstm.sqhstv[95] = (unsigned char  *)&creditaddamt2;
          sqlstm.sqhstl[95] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[95] = (         int  )0;
          sqlstm.sqindv[95] = (         short *)0;
          sqlstm.sqinds[95] = (         int  )0;
          ...
          sqlstm.sqadto[95] = (unsigned short )0;
          sqlstm.sqtdso[95] = (unsigned short )0;
          sqlstm.sqhstv[96] = (unsigned char  *)&creditaddamt3;
          sqlstm.sqhstl[96] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[96] = (         int  )0;
          sqlstm.sqindv[96] = (         short *)0;
          sqlstm.sqinds[96] = (         int  )0;
          ...
          sqlstm.sqadto[96] = (unsigned short )0;
          sqlstm.sqtdso[96] = (unsigned short )0;
          sqlstm.sqhstv[97] = (unsigned char  *)&creditaddamt4;
          sqlstm.sqhstl[97] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[97] = (         int  )0;
          sqlstm.sqindv[97] = (         short *)0;
          sqlstm.sqinds[97] = (         int  )0;
          ...
          sqlstm.sqadto[97] = (unsigned short )0;
          sqlstm.sqtdso[97] = (unsigned short )0;
          sqlstm.sqhstv[98] = (unsigned char  *)&npgiveamt2_2010;
          sqlstm.sqhstl[98] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[98] = (         int  )0;
          sqlstm.sqindv[98] = (         short *)0;
          sqlstm.sqinds[98] = (         int  )0;
          ...
          sqlstm.sqadto[98] = (unsigned short )0;
          sqlstm.sqtdso[98] = (unsigned short )0;
          sqlstm.sqhstv[99] = (unsigned char  *)&npgiveamt2_else;
          sqlstm.sqhstl[99] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[99] = (         int  )0;
          sqlstm.sqindv[99] = (         short *)0;
          sqlstm.sqinds[99] = (         int  )0;
          ...
          sqlstm.sqadto[99] = (unsigned short )0;
          sqlstm.sqtdso[99] = (unsigned short )0;
          sqlstm.sqhstv[100] = (unsigned char  *)&infanttaxded;
          sqlstm.sqhstl[100] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[100] = (         int  )0;
          sqlstm.sqindv[100] = (         short *)0;
          sqlstm.sqinds[100] = (         int  )0;
          ...
          sqlstm.sqadto[100] = (unsigned short )0;
          sqlstm.sqtdso[100] = (unsigned short )0;
          sqlstm.sqhstv[101] = (unsigned char  *)&addbabytaxded;
          sqlstm.sqhstl[101] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[101] = (         int  )0;
          sqlstm.sqindv[101] = (         short *)0;
          sqlstm.sqinds[101] = (         int  )0;
          ...
          sqlstm.sqadto[101] = (unsigned short )0;
          sqlstm.sqtdso[101] = (unsigned short )0;
          sqlstm.sqhstv[102] = (unsigned char  *)&obsguartaxded;
          sqlstm.sqhstl[102] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[102] = (         int  )0;
          sqlstm.sqindv[102] = (         short *)0;
          sqlstm.sqinds[102] = (         int  )0;
          ...
          sqlstm.sqadto[102] = (unsigned short )0;
          sqlstm.sqtdso[102] = (unsigned short )0;
          sqlstm.sqhstv[103] = (unsigned char  *)&nagiveamt_2014;
          sqlstm.sqhstl[103] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[103] = (         int  )0;
          sqlstm.sqindv[103] = (         short *)0;
          sqlstm.sqinds[103] = (         int  )0;
          ...
          sqlstm.sqadto[103] = (unsigned short )0;
          sqlstm.sqtdso[103] = (unsigned short )0;
          sqlstm.sqhstv[104] = (unsigned char  *)&npgiveamt_2014;
          sqlstm.sqhstl[104] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[104] = (         int  )0;
          sqlstm.sqindv[104] = (         short *)0;
          sqlstm.sqinds[104] = (         int  )0;
          ...
          sqlstm.sqadto[104] = (unsigned short )0;
          sqlstm.sqtdso[104] = (unsigned short )0;
          sqlstm.sqhstv[105] = (unsigned char  *)&npgiveamt2_2014;
          sqlstm.sqhstl[105] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[105] = (         int  )0;
          sqlstm.sqindv[105] = (         short *)0;
          sqlstm.sqinds[105] = (         int  )0;
          ...
          sqlstm.sqadto[105] = (unsigned short )0;
          sqlstm.sqtdso[105] = (unsigned short )0;
          sqlstm.sqhstv[106] = (unsigned char  *)&nagiveded_2014;
          sqlstm.sqhstl[106] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[106] = (         int  )0;
          sqlstm.sqindv[106] = (         short *)0;
          sqlstm.sqinds[106] = (         int  )0;
          ...
          sqlstm.sqadto[106] = (unsigned short )0;
          sqlstm.sqtdso[106] = (unsigned short )0;
          sqlstm.sqhstv[107] = (unsigned char  *)&npgiveded_2014;
          sqlstm.sqhstl[107] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[107] = (         int  )0;
          sqlstm.sqindv[107] = (         short *)0;
          sqlstm.sqinds[107] = (         int  )0;
          ...
          sqlstm.sqadto[107] = (unsigned short )0;
          sqlstm.sqtdso[107] = (unsigned short )0;
          sqlstm.sqhstv[108] = (unsigned char  *)&npgiveded2_2014;
          sqlstm.sqhstl[108] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[108] = (         int  )0;
          sqlstm.sqindv[108] = (         short *)0;
          sqlstm.sqinds[108] = (         int  )0;
          ...
          sqlstm.sqadto[108] = (unsigned short )0;
          sqlstm.sqtdso[108] = (unsigned short )0;
          sqlstm.sqhstv[109] = (unsigned char  *)&houseintamt6;
          sqlstm.sqhstl[109] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[109] = (         int  )0;
          sqlstm.sqindv[109] = (         short *)0;
          sqlstm.sqinds[109] = (         int  )0;
          ...
          sqlstm.sqadto[109] = (unsigned short )0;
          sqlstm.sqtdso[109] = (unsigned short )0;
          sqlstm.sqhstv[110] = (unsigned char  *)&houseintamt7;
          sqlstm.sqhstl[110] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[110] = (         int  )0;
          sqlstm.sqindv[110] = (         short *)0;
          sqlstm.sqinds[110] = (         int  )0;
          ...
          sqlstm.sqadto[110] = (unsigned short )0;
          sqlstm.sqtdso[110] = (unsigned short )0;
          sqlstm.sqhstv[111] = (unsigned char  *)&houseintamt8;
          sqlstm.sqhstl[111] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[111] = (         int  )0;
          sqlstm.sqindv[111] = (         short *)0;
          sqlstm.sqinds[111] = (         int  )0;
          ...
          sqlstm.sqadto[111] = (unsigned short )0;
          sqlstm.sqtdso[111] = (unsigned short )0;
          sqlstm.sqhstv[112] = (unsigned char  *)&houseintamt9;
          sqlstm.sqhstl[112] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[112] = (         int  )0;
          sqlstm.sqindv[112] = (         short *)0;
          sqlstm.sqinds[112] = (         int  )0;
          ...
          sqlstm.sqadto[112] = (unsigned short )0;
          sqlstm.sqtdso[112] = (unsigned short )0;
          sqlstm.sqhstv[113] = (unsigned char  *)&houseintded6;
          sqlstm.sqhstl[113] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[113] = (         int  )0;
          sqlstm.sqindv[113] = (         short *)0;
          sqlstm.sqinds[113] = (         int  )0;
          ...
          sqlstm.sqadto[113] = (unsigned short )0;
          sqlstm.sqtdso[113] = (unsigned short )0;
          sqlstm.sqhstv[114] = (unsigned char  *)&houseintded7;
          sqlstm.sqhstl[114] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[114] = (         int  )0;
          sqlstm.sqindv[114] = (         short *)0;
          sqlstm.sqinds[114] = (         int  )0;
          ...
          sqlstm.sqadto[114] = (unsigned short )0;
          sqlstm.sqtdso[114] = (unsigned short )0;
          sqlstm.sqhstv[115] = (unsigned char  *)&houseintded8;
          sqlstm.sqhstl[115] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[115] = (         int  )0;
          sqlstm.sqindv[115] = (         short *)0;
          sqlstm.sqinds[115] = (         int  )0;
          ...
          sqlstm.sqadto[115] = (unsigned short )0;
          sqlstm.sqtdso[115] = (unsigned short )0;
          sqlstm.sqhstv[116] = (unsigned char  *)&houseintded9;
          sqlstm.sqhstl[116] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[116] = (         int  )0;
          sqlstm.sqindv[116] = (         short *)0;
          sqlstm.sqinds[116] = (         int  )0;
          ...
          sqlstm.sqadto[116] = (unsigned short )0;
          sqlstm.sqtdso[116] = (unsigned short )0;
          sqlstm.sqhstv[117] = (unsigned char  *)&investamt8;
          sqlstm.sqhstl[117] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[117] = (         int  )0;
          sqlstm.sqindv[117] = (         short *)0;
          sqlstm.sqinds[117] = (         int  )0;
          ...
          sqlstm.sqadto[117] = (unsigned short )0;
          sqlstm.sqtdso[117] = (unsigned short )0;
          sqlstm.sqhstv[118] = (unsigned char  *)&investamt9;
          sqlstm.sqhstl[118] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[118] = (         int  )0;
          sqlstm.sqindv[118] = (         short *)0;
          sqlstm.sqinds[118] = (         int  )0;
          ...
          sqlstm.sqadto[118] = (unsigned short )0;
          sqlstm.sqtdso[118] = (unsigned short )0;
          sqlstm.sqhstv[119] = (unsigned char  *)&investamt10;
          sqlstm.sqhstl[119] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[119] = (         int  )0;
          sqlstm.sqindv[119] = (         short *)0;
          sqlstm.sqinds[119] = (         int  )0;
          ...
          sqlstm.sqadto[119] = (unsigned short )0;
          sqlstm.sqtdso[119] = (unsigned short )0;
          sqlstm.sqhstv[120] = (unsigned char  *)&investamt11;
          sqlstm.sqhstl[120] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[120] = (         int  )0;
          sqlstm.sqindv[120] = (         short *)0;
          sqlstm.sqinds[120] = (         int  )0;
          ...
          sqlstm.sqadto[120] = (unsigned short )0;
          sqlstm.sqtdso[120] = (unsigned short )0;
          sqlstm.sqhstv[121] = (unsigned char  *)&investded4;
          sqlstm.sqhstl[121] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[121] = (         int  )0;
          sqlstm.sqindv[121] = (         short *)0;
          sqlstm.sqinds[121] = (         int  )0;
          ...
          sqlstm.sqadto[121] = (unsigned short )0;
          sqlstm.sqtdso[121] = (unsigned short )0;
          sqlstm.sqhstv[122] = (unsigned char  *)&creditaddamt5;
          sqlstm.sqhstl[122] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[122] = (         int  )0;
          sqlstm.sqindv[122] = (         short *)0;
          sqlstm.sqinds[122] = (         int  )0;
          ...
          sqlstm.sqadto[122] = (unsigned short )0;
          sqlstm.sqtdso[122] = (unsigned short )0;
          sqlstm.sqhstv[123] = (unsigned char  *)&creditaddamt6;
          sqlstm.sqhstl[123] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[123] = (         int  )0;
          sqlstm.sqindv[123] = (         short *)0;
          sqlstm.sqinds[123] = (         int  )0;
          ...
          sqlstm.sqadto[123] = (unsigned short )0;
          sqlstm.sqtdso[123] = (unsigned short )0;
          sqlstm.sqhstv[124] = (unsigned char  *)&creditaddamt7;
          sqlstm.sqhstl[124] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[124] = (         int  )0;
          sqlstm.sqindv[124] = (         short *)0;
          sqlstm.sqinds[124] = (         int  )0;
          ...
          sqlstm.sqadto[124] = (unsigned short )0;
          sqlstm.sqtdso[124] = (unsigned short )0;
          sqlstm.sqhstv[125] = (unsigned char  *)&ihosamt;
          sqlstm.sqhstl[125] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[125] = (         int  )0;
          sqlstm.sqindv[125] = (         short *)0;
          sqlstm.sqinds[125] = (         int  )0;
          ...
          sqlstm.sqadto[125] = (unsigned short )0;
          sqlstm.sqtdso[125] = (unsigned short )0;
          sqlstm.sqhstv[126] = (unsigned char  *)&rpenamt;
          ...
          sqlstm.sqhstv[127] = (unsigned char  *)&rpended;
          ...
          sqlstm.sqhstv[128] = (unsigned char  *)&rpentaxded;
...

{
          ...
          sqlstm.sqltdsp = &sqltds;
          sqlbuft((void **)0,
            "select NVL(sum( case  when (NEWORKYY<'2014' and givecod='10') t\
hen DEDAMT else 0  end ),0) NAGIVEAMT ,NVL(sum( case  when (NEWORKYY<'2014' \
and (givecod='30' or givecod='31')) then DEDAMT else 0  end ),0) NSPGIVAMT ,\
NVL(sum( case  when (NEWORKYY<'2014' and givecod='40') then DEDAMT else 0  e\
nd ),0) NPGIVEAMT2 ,NVL(sum( case  when (NEWORKYY='2010' and givecod='40') t\
hen DEDAMT else 0  end ),0) NPGIVEAMT2_2010 ,NVL(sum( case  when (NEWORKYY>'\
2010' and givecod='40') then DEDAMT else 0  end ),0) NPGIVEAMT2_ELSE ,NVL(su\
m( case  when (NEWORKYY<'2014' and givecod='41') then DEDAMT else 0  end ),0\
) NPGIVEAMT ,NVL(sum( case  when (NEWORKYY>='2014' and givecod='10') then DE\
DAMT else 0  end ),0) NAGIVEAMT_2014 ,NVL(sum( case  when (NEWORKYY>='2014' \
and givecod='40') then DEDAMT else 0  end ),0) NPGIVEAMT2_2014 ,NVL(sum( cas\
e  when (NEWORKYY>='2014' and givecod='41') then DEDAMT else 0  end ),0) NPG\
IVEAMT_2014 into :b0,:b1,:b2,:b3,:b4,:b5,:b6,:b7,:b8  from PKMYSGIVNE where \
((WORKYY=(select workyy  from pkcpbas ) and EMPNO");
          sqlstm.stmt = "=:b9) and WORKYY>NEWORKYY) group by EMPNO";
          sqlstm.iters = (unsigned int  )1;
          ...
          sqlstm.sqlety = (unsigned short)4352;
          sqlstm.occurs = (unsigned int  )0;
          sqlstm.sqhstv[0] = (unsigned char  *)&nagiveamt;
          sqlstm.sqhstl[0] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[0] = (         int  )0;
          sqlstm.sqindv[0] = (         short *)0;
          sqlstm.sqinds[0] = (         int  )0;
          ...
          sqlstm.sqadto[0] = (unsigned short )0;
          sqlstm.sqtdso[0] = (unsigned short )0;
          sqlstm.sqhstv[1] = (unsigned char  *)&nspgivamt;
          sqlstm.sqhstl[1] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[1] = (         int  )0;
          sqlstm.sqindv[1] = (         short *)0;
          sqlstm.sqinds[1] = (         int  )0;
          ...
          sqlstm.sqadto[1] = (unsigned short )0;
          sqlstm.sqtdso[1] = (unsigned short )0;
          sqlstm.sqhstv[2] = (unsigned char  *)&npgiveamt2;
          sqlstm.sqhstl[2] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[2] = (         int  )0;
          sqlstm.sqindv[2] = (         short *)0;
          sqlstm.sqinds[2] = (         int  )0;
          ...
          sqlstm.sqadto[2] = (unsigned short )0;
          sqlstm.sqtdso[2] = (unsigned short )0;
          sqlstm.sqhstv[3] = (unsigned char  *)&npgiveamt2_2010;
          sqlstm.sqhstl[3] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[3] = (         int  )0;
          sqlstm.sqindv[3] = (         short *)0;
          sqlstm.sqinds[3] = (         int  )0;
          ...
          sqlstm.sqadto[3] = (unsigned short )0;
          sqlstm.sqtdso[3] = (unsigned short )0;
          sqlstm.sqhstv[4] = (unsigned char  *)&npgiveamt2_else;
          sqlstm.sqhstl[4] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[4] = (         int  )0;
          sqlstm.sqindv[4] = (         short *)0;
          sqlstm.sqinds[4] = (         int  )0;
          ...
          sqlstm.sqadto[4] = (unsigned short )0;
          sqlstm.sqtdso[4] = (unsigned short )0;
          sqlstm.sqhstv[5] = (unsigned char  *)&npgiveamt;
          sqlstm.sqhstl[5] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[5] = (         int  )0;
          sqlstm.sqindv[5] = (         short *)0;
          sqlstm.sqinds[5] = (         int  )0;
          ...
          sqlstm.sqadto[5] = (unsigned short )0;
          sqlstm.sqtdso[5] = (unsigned short )0;
          sqlstm.sqhstv[6] = (unsigned char  *)&nagiveamt_2014;
          sqlstm.sqhstl[6] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[6] = (         int  )0;
          sqlstm.sqindv[6] = (         short *)0;
          sqlstm.sqinds[6] = (         int  )0;
          ...
          sqlstm.sqadto[6] = (unsigned short )0;
          sqlstm.sqtdso[6] = (unsigned short )0;
          sqlstm.sqhstv[7] = (unsigned char  *)&npgiveamt2_2014;
          sqlstm.sqhstl[7] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[7] = (         int  )0;
          sqlstm.sqindv[7] = (         short *)0;
          sqlstm.sqinds[7] = (         int  )0;
          ...
          sqlstm.sqadto[7] = (unsigned short )0;
          sqlstm.sqtdso[7] = (unsigned short )0;
          sqlstm.sqhstv[8] = (unsigned char  *)&npgiveamt_2014;
          sqlstm.sqhstl[8] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[8] = (         int  )0;
          sqlstm.sqindv[8] = (         short *)0;
          sqlstm.sqinds[8] = (         int  )0;
...
/* 그밖의 소득공제 START=====================================================================*/
          ...
          */ 
          ...
          investded_2015_1 = floor( (investamt8 * INVESTRATE7 / 100) ); /* 2014.12 jissi */                                                       
...

{
          ...
          sqlstm.sqadto[1] = (unsigned short )0;
          sqlstm.sqtdso[1] = (unsigned short )0;
          sqlstm.sqhstv[2] = (unsigned char  *)&yloanded;
          sqlstm.sqhstl[2] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[2] = (         int  )0;
          sqlstm.sqindv[2] = (         short *)0;
          sqlstm.sqinds[2] = (         int  )0;
...

{
          ...
          sqlstm.sqladtp = &sqladt;
          sqlstm.sqltdsp = &sqltds;
          sqlstm.stmt = "update PKMYSRENT  set YLOANDED=:b0,WRITEMAN=:b1,WR\
ITETIME=to_char(sysdate,'yyyymmddhh24miss') where ((WORKYY=(select workyy  fr\
om pkcpbas ) and EMPNO=:b2) and SEQ=:b3)";
          sqlstm.iters = (unsigned int  )1;
          ...
          sqlstm.sqadto[2] = (unsigned short )0;
          sqlstm.sqtdso[2] = (unsigned short )0;
          sqlstm.sqhstv[3] = (unsigned char  *)&yseq;
          sqlstm.sqhstl[3] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[3] = (         int  )0;
          sqlstm.sqindv[3] = (         short *)0;
          sqlstm.sqinds[3] = (         int  )0;
...

{
          ...
          sqlstm.sqadto[1] = (unsigned short )0;
          sqlstm.sqtdso[1] = (unsigned short )0;
          sqlstm.sqhstv[2] = (unsigned char  *)&mrentcostded;
          sqlstm.sqhstl[2] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[2] = (         int  )0;
          sqlstm.sqindv[2] = (         short *)0;
          sqlstm.sqinds[2] = (         int  )0;
...

{
          ...
          sqlstm.sqladtp = &sqladt;
          sqlstm.sqltdsp = &sqltds;
          sqlstm.stmt = "update PKMYSRENT  set MRENTCOSTDED=:b0,WRITEMAN=:b\
1,WRITETIME=to_char(sysdate,'yyyymmddhh24miss') where ((WORKYY=(select workyy\
  from pkcpbas ) and EMPNO=:b2) and SEQ=:b3)";
          sqlstm.iters = (unsigned int  )1;
          ...
          sqlstm.sqadto[2] = (unsigned short )0;
          sqlstm.sqtdso[2] = (unsigned short )0;
          sqlstm.sqhstv[3] = (unsigned char  *)&mseq;
          sqlstm.sqhstl[3] = (unsigned long )sizeof(double);
          sqlstm.sqhsts[3] = (         int  )0;
          sqlstm.sqindv[3] = (         short *)0;
          sqlstm.sqinds[3] = (         int  )0;
...

{
     ...
     sqlstm.sqltdsp = &sqltds;
     sqlbuft((void **)0,
       "update PKZYSMAS  set LABORDED=:b0,LABORAMT=:b1,SELFDED=:b2,MATEDED=:\
b3,FAMIDED=:b4,BASICDED=:b5,OLDDED=:b6,OBSDED=:b7,WOMANDED=:b8,CHILDDED=:b9,\
BABYDED=:b10,SPARENTDED=:b11,APPENDDED=:b12,FEWNO=:b13,FEWDED=:b14,MEDDED=:b\
15,HIREDED=:b16,GUARDED=:b17,OBSGUARDED=:b18,INSDED=:b19,HOSAMT=:b20,OBSHOSD\
ED=:b21,HOSDED=:b22,SEDUDED=:b23,KEDUDED=:b24,CEDUDED=:b25,UEDUDED=:b26,OBSE\
DUDED=:b27,EDUDED=:b28,HOUSEDED=:b29,HOUSEDED2=:b30,HOUSEDED3=:b31,HOUSERENT\
DED=:b32,HOUSVSUBDED=:b33,HOUSVCOMDED=:b34,HOUSVEMPDED=:b35,HOUSEINTDED=:b36\
,HOUSEINTDED2=:b37,HOUSEINTDED3=:b38,HOUSEINTDED4=:b39,HOUSEINTDED5=:b40,AGI\
VEDED=:b41,POLITAXDED=:b42,SPGIVDED=:b43,PGIVEDED=:b44,PGIVEDED2=:b45,NPGIVE\
AMT=:b46,NPGIVEAMT2=:b47,GIVEDED=:b48,SPECIALDED=:b49,STANDDED=:b50,CHAGAMAM\
T=:b51,ANUDED=:b52,PENDED=:b53,NPENDED=:b54,CREDITAMT=:b55,CREDITDED=:b56,SP\
ECADDDED=:b57,POLIDED=:b58,INVESTDED=:b59,INVESTDED2=:b60,OINVESTDED=:b61,TI\
NVESTDED=:b62,INCOMTDED=:b63,HLOANDED=:b64,FUNDDED=:b65,COSTOCKDED=:b66,FORI\
DED=:b67,ETCTDED=:b68,TDEDSUM=:b69,HSRENTIND");
     sqlstm.stmt = "ED=:b70,INCOMEDED=:b71,SPLIMITOVDED=:b72,NEPGIVEDED=:b7\
3,NEPGIVEDED2=:b74,NAGIVEDED=:b75,NPGIVEDED=:b76,NPGIVEDED2=:b77,NGIVEDED=:b7\
8,INVESTDED3=:b79,LONGFUNDDED=:b80,CHILDTAXDED=:b81,INFANTTAXDED=:b82,ADDBABY\
TAXDED=:b83,NPENDTAXDED=:b84,GUARTAXDED=:b85,OBSGUARTAXDED=:b86,HOSTAXDED=:b8\
7,EDUTAXDED=:b88,POLIDED1=:b89,POLIDED2=:b90,POLITAXDED1=:b91,POLITAXDED2=:b9\
2,AGIVETAXDED=:b93,PGIVETAXDED=:b94,TAXDEDSUM=:b95,HOUSERENTTAXDED=:b96,NPGIV\
EAMT2_2010=:b97,NPGIVEAMT2_ELSE=:b98,nagiveamt_2014=:b99,npgiveamt_2014=:b100\
,npgiveamt2_2014=:b101,nagiveded_2014=:b102,npgiveded_2014=:b103,npgiveded2_2\
014=:b104,houseintded6=:b105,houseintded7=:b106,houseintded8=:b107,houseintde\
d9=:b108,investded4=:b109,rpended=:b110,rpentaxded=:b111,TAXLEVEL=:b112,CALCT\
AX=:b113,DINTAX=:b114,DJUTAX=:b115,DNONGTAX=:b116,INTAX=:b117,JUTAX=:b118,NON\
GTAX=:b119,YINTAX=:b120,YJUTAX=:b121,YNONGTAX=:b122,YCALCTAX=:b123,SUBDATE=:b\
124,WRITEMAN=:b125,WRITETIME=to_char(sysdate,'yyyymmddhh24miss') where EMPNO=\
:b126";
     sqlstm.iters = (unsigned int  )1;
     ...
     sqlstm.sqadto[9] = (unsigned short )0;
     sqlstm.sqtdso[9] = (unsigned short )0;
     sqlstm.sqhstv[10] = (unsigned char  *)&babyded;
     sqlstm.sqhstl[10] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[10] = (         int  )0;
     sqlstm.sqindv[10] = (         short *)0;
     sqlstm.sqinds[10] = (         int  )0;
     ...
     sqlstm.sqadto[10] = (unsigned short )0;
     sqlstm.sqtdso[10] = (unsigned short )0;
     sqlstm.sqhstv[11] = (unsigned char  *)&sparentded;
     sqlstm.sqhstl[11] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[11] = (         int  )0;
     sqlstm.sqindv[11] = (         short *)0;
     sqlstm.sqinds[11] = (         int  )0;
     ...
     sqlstm.sqadto[21] = (unsigned short )0;
     sqlstm.sqtdso[21] = (unsigned short )0;
     sqlstm.sqhstv[22] = (unsigned char  *)&hosded;
     sqlstm.sqhstl[22] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[22] = (         int  )0;
     sqlstm.sqindv[22] = (         short *)0;
     sqlstm.sqinds[22] = (         int  )0;
     ...
     sqlstm.sqadto[22] = (unsigned short )0;
     sqlstm.sqtdso[22] = (unsigned short )0;
     sqlstm.sqhstv[23] = (unsigned char  *)&seduded;
     sqlstm.sqhstl[23] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[23] = (         int  )0;
     sqlstm.sqindv[23] = (         short *)0;
     sqlstm.sqinds[23] = (         int  )0;
     ...
     sqlstm.sqadto[23] = (unsigned short )0;
     sqlstm.sqtdso[23] = (unsigned short )0;
     sqlstm.sqhstv[24] = (unsigned char  *)&keduded;
     sqlstm.sqhstl[24] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[24] = (         int  )0;
     sqlstm.sqindv[24] = (         short *)0;
     sqlstm.sqinds[24] = (         int  )0;
     ...
     sqlstm.sqadto[24] = (unsigned short )0;
     sqlstm.sqtdso[24] = (unsigned short )0;
     sqlstm.sqhstv[25] = (unsigned char  *)&ceduded;
     sqlstm.sqhstl[25] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[25] = (         int  )0;
     sqlstm.sqindv[25] = (         short *)0;
     sqlstm.sqinds[25] = (         int  )0;
     ...
     sqlstm.sqadto[25] = (unsigned short )0;
     sqlstm.sqtdso[25] = (unsigned short )0;
     sqlstm.sqhstv[26] = (unsigned char  *)&ueduded;
     sqlstm.sqhstl[26] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[26] = (         int  )0;
     sqlstm.sqindv[26] = (         short *)0;
     sqlstm.sqinds[26] = (         int  )0;
     ...
     sqlstm.sqadto[26] = (unsigned short )0;
     sqlstm.sqtdso[26] = (unsigned short )0;
     sqlstm.sqhstv[27] = (unsigned char  *)&obseduded;
     sqlstm.sqhstl[27] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[27] = (         int  )0;
     sqlstm.sqindv[27] = (         short *)0;
     sqlstm.sqinds[27] = (         int  )0;
     ...
     sqlstm.sqadto[28] = (unsigned short )0;
     sqlstm.sqtdso[28] = (unsigned short )0;
     sqlstm.sqhstv[29] = (unsigned char  *)&houseded;
     sqlstm.sqhstl[29] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[29] = (         int  )0;
     sqlstm.sqindv[29] = (         short *)0;
     sqlstm.sqinds[29] = (         int  )0;
     ...
     sqlstm.sqadto[29] = (unsigned short )0;
     sqlstm.sqtdso[29] = (unsigned short )0;
     sqlstm.sqhstv[30] = (unsigned char  *)&houseded2;
     sqlstm.sqhstl[30] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[30] = (         int  )0;
     sqlstm.sqindv[30] = (         short *)0;
     sqlstm.sqinds[30] = (         int  )0;
     ...
     sqlstm.sqadto[30] = (unsigned short )0;
     sqlstm.sqtdso[30] = (unsigned short )0;
     sqlstm.sqhstv[31] = (unsigned char  *)&houseded3;
     sqlstm.sqhstl[31] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[31] = (         int  )0;
     sqlstm.sqindv[31] = (         short *)0;
     sqlstm.sqinds[31] = (         int  )0;
     ...
     sqlstm.sqadto[31] = (unsigned short )0;
     sqlstm.sqtdso[31] = (unsigned short )0;
     sqlstm.sqhstv[32] = (unsigned char  *)&houserentded;
     sqlstm.sqhstl[32] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[32] = (         int  )0;
     sqlstm.sqindv[32] = (         short *)0;
     sqlstm.sqinds[32] = (         int  )0;
     ...
     sqlstm.sqadto[32] = (unsigned short )0;
     sqlstm.sqtdso[32] = (unsigned short )0;
     sqlstm.sqhstv[33] = (unsigned char  *)&housvsubded;
     sqlstm.sqhstl[33] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[33] = (         int  )0;
     sqlstm.sqindv[33] = (         short *)0;
     sqlstm.sqinds[33] = (         int  )0;
     ...
     sqlstm.sqadto[33] = (unsigned short )0;
     sqlstm.sqtdso[33] = (unsigned short )0;
     sqlstm.sqhstv[34] = (unsigned char  *)&housvcomded;
     sqlstm.sqhstl[34] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[34] = (         int  )0;
     sqlstm.sqindv[34] = (         short *)0;
     sqlstm.sqinds[34] = (         int  )0;
     ...
     sqlstm.sqadto[34] = (unsigned short )0;
     sqlstm.sqtdso[34] = (unsigned short )0;
     sqlstm.sqhstv[35] = (unsigned char  *)&housvempded;
     sqlstm.sqhstl[35] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[35] = (         int  )0;
     sqlstm.sqindv[35] = (         short *)0;
     sqlstm.sqinds[35] = (         int  )0;
     ...
     sqlstm.sqadto[35] = (unsigned short )0;
     sqlstm.sqtdso[35] = (unsigned short )0;
     sqlstm.sqhstv[36] = (unsigned char  *)&houseintded;
     sqlstm.sqhstl[36] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[36] = (         int  )0;
     sqlstm.sqindv[36] = (         short *)0;
     sqlstm.sqinds[36] = (         int  )0;
     ...
     sqlstm.sqadto[36] = (unsigned short )0;
     sqlstm.sqtdso[36] = (unsigned short )0;
     sqlstm.sqhstv[37] = (unsigned char  *)&houseintded2;
     sqlstm.sqhstl[37] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[37] = (         int  )0;
     sqlstm.sqindv[37] = (         short *)0;
     sqlstm.sqinds[37] = (         int  )0;
     ...
     sqlstm.sqadto[37] = (unsigned short )0;
     sqlstm.sqtdso[37] = (unsigned short )0;
     sqlstm.sqhstv[38] = (unsigned char  *)&houseintded3;
     sqlstm.sqhstl[38] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[38] = (         int  )0;
     sqlstm.sqindv[38] = (         short *)0;
     sqlstm.sqinds[38] = (         int  )0;
     ...
     sqlstm.sqadto[38] = (unsigned short )0;
     sqlstm.sqtdso[38] = (unsigned short )0;
     sqlstm.sqhstv[39] = (unsigned char  *)&houseintded4;
     sqlstm.sqhstl[39] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[39] = (         int  )0;
     sqlstm.sqindv[39] = (         short *)0;
     sqlstm.sqinds[39] = (         int  )0;
     ...
     sqlstm.sqadto[39] = (unsigned short )0;
     sqlstm.sqtdso[39] = (unsigned short )0;
     sqlstm.sqhstv[40] = (unsigned char  *)&houseintded5;
     sqlstm.sqhstl[40] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[40] = (         int  )0;
     sqlstm.sqindv[40] = (         short *)0;
     sqlstm.sqinds[40] = (         int  )0;
     ...
     sqlstm.sqadto[40] = (unsigned short )0;
     sqlstm.sqtdso[40] = (unsigned short )0;
     sqlstm.sqhstv[41] = (unsigned char  *)&agiveded;
     sqlstm.sqhstl[41] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[41] = (         int  )0;
     sqlstm.sqindv[41] = (         short *)0;
     sqlstm.sqinds[41] = (         int  )0;
     ...
     sqlstm.sqadto[41] = (unsigned short )0;
     sqlstm.sqtdso[41] = (unsigned short )0;
     sqlstm.sqhstv[42] = (unsigned char  *)&politaxded;
     sqlstm.sqhstl[42] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[42] = (         int  )0;
     sqlstm.sqindv[42] = (         short *)0;
     sqlstm.sqinds[42] = (         int  )0;
     ...
     sqlstm.sqadto[42] = (unsigned short )0;
     sqlstm.sqtdso[42] = (unsigned short )0;
     sqlstm.sqhstv[43] = (unsigned char  *)&spgivded;
     sqlstm.sqhstl[43] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[43] = (         int  )0;
     sqlstm.sqindv[43] = (         short *)0;
     sqlstm.sqinds[43] = (         int  )0;
     ...
     sqlstm.sqadto[43] = (unsigned short )0;
     sqlstm.sqtdso[43] = (unsigned short )0;
     sqlstm.sqhstv[44] = (unsigned char  *)&pgiveded;
     sqlstm.sqhstl[44] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[44] = (         int  )0;
     sqlstm.sqindv[44] = (         short *)0;
     sqlstm.sqinds[44] = (         int  )0;
     ...
     sqlstm.sqadto[44] = (unsigned short )0;
     sqlstm.sqtdso[44] = (unsigned short )0;
     sqlstm.sqhstv[45] = (unsigned char  *)&pgiveded2;
     sqlstm.sqhstl[45] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[45] = (         int  )0;
     sqlstm.sqindv[45] = (         short *)0;
     sqlstm.sqinds[45] = (         int  )0;
     ...
     sqlstm.sqadto[45] = (unsigned short )0;
     sqlstm.sqtdso[45] = (unsigned short )0;
     sqlstm.sqhstv[46] = (unsigned char  *)&npgiveamt;
     sqlstm.sqhstl[46] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[46] = (         int  )0;
     sqlstm.sqindv[46] = (         short *)0;
     sqlstm.sqinds[46] = (         int  )0;
     ...
     sqlstm.sqadto[46] = (unsigned short )0;
     sqlstm.sqtdso[46] = (unsigned short )0;
     sqlstm.sqhstv[47] = (unsigned char  *)&npgiveamt2;
     sqlstm.sqhstl[47] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[47] = (         int  )0;
     sqlstm.sqindv[47] = (         short *)0;
     sqlstm.sqinds[47] = (         int  )0;
     ...
     sqlstm.sqadto[47] = (unsigned short )0;
     sqlstm.sqtdso[47] = (unsigned short )0;
     sqlstm.sqhstv[48] = (unsigned char  *)&giveded;
     sqlstm.sqhstl[48] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[48] = (         int  )0;
     sqlstm.sqindv[48] = (         short *)0;
     sqlstm.sqinds[48] = (         int  )0;
     ...
     sqlstm.sqadto[48] = (unsigned short )0;
     sqlstm.sqtdso[48] = (unsigned short )0;
     sqlstm.sqhstv[49] = (unsigned char  *)&specialded;
     sqlstm.sqhstl[49] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[49] = (         int  )0;
     sqlstm.sqindv[49] = (         short *)0;
     sqlstm.sqinds[49] = (         int  )0;
     ...
     sqlstm.sqadto[49] = (unsigned short )0;
     sqlstm.sqtdso[49] = (unsigned short )0;
     sqlstm.sqhstv[50] = (unsigned char  *)&standded;
     sqlstm.sqhstl[50] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[50] = (         int  )0;
     sqlstm.sqindv[50] = (         short *)0;
     sqlstm.sqinds[50] = (         int  )0;
     ...
     sqlstm.sqadto[50] = (unsigned short )0;
     sqlstm.sqtdso[50] = (unsigned short )0;
     sqlstm.sqhstv[51] = (unsigned char  *)&chagamamt;
     sqlstm.sqhstl[51] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[51] = (         int  )0;
     sqlstm.sqindv[51] = (         short *)0;
     sqlstm.sqinds[51] = (         int  )0;
     ...
     sqlstm.sqadto[51] = (unsigned short )0;
     sqlstm.sqtdso[51] = (unsigned short )0;
     sqlstm.sqhstv[52] = (unsigned char  *)&anuded;
     sqlstm.sqhstl[52] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[52] = (         int  )0;
     sqlstm.sqindv[52] = (         short *)0;
     sqlstm.sqinds[52] = (         int  )0;
     ...
     sqlstm.sqadto[52] = (unsigned short )0;
     sqlstm.sqtdso[52] = (unsigned short )0;
     sqlstm.sqhstv[53] = (unsigned char  *)&pended;
     sqlstm.sqhstl[53] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[53] = (         int  )0;
     sqlstm.sqindv[53] = (         short *)0;
     sqlstm.sqinds[53] = (         int  )0;
     ...
     sqlstm.sqadto[53] = (unsigned short )0;
     sqlstm.sqtdso[53] = (unsigned short )0;
     sqlstm.sqhstv[54] = (unsigned char  *)&npended;
     sqlstm.sqhstl[54] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[54] = (         int  )0;
     sqlstm.sqindv[54] = (         short *)0;
     sqlstm.sqinds[54] = (         int  )0;
     ...
     sqlstm.sqadto[54] = (unsigned short )0;
     sqlstm.sqtdso[54] = (unsigned short )0;
     sqlstm.sqhstv[55] = (unsigned char  *)&creditamt;
     sqlstm.sqhstl[55] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[55] = (         int  )0;
     sqlstm.sqindv[55] = (         short *)0;
     sqlstm.sqinds[55] = (         int  )0;
     ...
     sqlstm.sqadto[55] = (unsigned short )0;
     sqlstm.sqtdso[55] = (unsigned short )0;
     sqlstm.sqhstv[56] = (unsigned char  *)&creditded;
     sqlstm.sqhstl[56] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[56] = (         int  )0;
     sqlstm.sqindv[56] = (         short *)0;
     sqlstm.sqinds[56] = (         int  )0;
     ...
     sqlstm.sqadto[56] = (unsigned short )0;
     sqlstm.sqtdso[56] = (unsigned short )0;
     sqlstm.sqhstv[57] = (unsigned char  *)&specaddded;
     sqlstm.sqhstl[57] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[57] = (         int  )0;
     sqlstm.sqindv[57] = (         short *)0;
     sqlstm.sqinds[57] = (         int  )0;
     ...
     sqlstm.sqadto[57] = (unsigned short )0;
     sqlstm.sqtdso[57] = (unsigned short )0;
     sqlstm.sqhstv[58] = (unsigned char  *)&polided;
     sqlstm.sqhstl[58] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[58] = (         int  )0;
     sqlstm.sqindv[58] = (         short *)0;
     sqlstm.sqinds[58] = (         int  )0;
     ...
     sqlstm.sqadto[58] = (unsigned short )0;
     sqlstm.sqtdso[58] = (unsigned short )0;
     sqlstm.sqhstv[59] = (unsigned char  *)&investded;
     sqlstm.sqhstl[59] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[59] = (         int  )0;
     sqlstm.sqindv[59] = (         short *)0;
     sqlstm.sqinds[59] = (         int  )0;
     ...
     sqlstm.sqadto[59] = (unsigned short )0;
     sqlstm.sqtdso[59] = (unsigned short )0;
     sqlstm.sqhstv[60] = (unsigned char  *)&investded2;
     sqlstm.sqhstl[60] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[60] = (         int  )0;
     sqlstm.sqindv[60] = (         short *)0;
     sqlstm.sqinds[60] = (         int  )0;
     ...
     sqlstm.sqadto[60] = (unsigned short )0;
     sqlstm.sqtdso[60] = (unsigned short )0;
     sqlstm.sqhstv[61] = (unsigned char  *)&oinvestded;
     sqlstm.sqhstl[61] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[61] = (         int  )0;
     sqlstm.sqindv[61] = (         short *)0;
     sqlstm.sqinds[61] = (         int  )0;
     ...
     sqlstm.sqadto[61] = (unsigned short )0;
     sqlstm.sqtdso[61] = (unsigned short )0;
     sqlstm.sqhstv[62] = (unsigned char  *)&tinvestded;
     sqlstm.sqhstl[62] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[62] = (         int  )0;
     sqlstm.sqindv[62] = (         short *)0;
     sqlstm.sqinds[62] = (         int  )0;
     ...
     sqlstm.sqadto[62] = (unsigned short )0;
     sqlstm.sqtdso[62] = (unsigned short )0;
     sqlstm.sqhstv[63] = (unsigned char  *)&incomtded;
     sqlstm.sqhstl[63] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[63] = (         int  )0;
     sqlstm.sqindv[63] = (         short *)0;
     sqlstm.sqinds[63] = (         int  )0;
     ...
     sqlstm.sqadto[63] = (unsigned short )0;
     sqlstm.sqtdso[63] = (unsigned short )0;
     sqlstm.sqhstv[64] = (unsigned char  *)&hloanded;
     sqlstm.sqhstl[64] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[64] = (         int  )0;
     sqlstm.sqindv[64] = (         short *)0;
     sqlstm.sqinds[64] = (         int  )0;
     ...
     sqlstm.sqadto[64] = (unsigned short )0;
     sqlstm.sqtdso[64] = (unsigned short )0;
     sqlstm.sqhstv[65] = (unsigned char  *)&fundded;
     sqlstm.sqhstl[65] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[65] = (         int  )0;
     sqlstm.sqindv[65] = (         short *)0;
     sqlstm.sqinds[65] = (         int  )0;
     ...
     sqlstm.sqadto[69] = (unsigned short )0;
     sqlstm.sqtdso[69] = (unsigned short )0;
     sqlstm.sqhstv[70] = (unsigned char  *)&hsrentinded;
     sqlstm.sqhstl[70] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[70] = (         int  )0;
     sqlstm.sqindv[70] = (         short *)0;
     sqlstm.sqinds[70] = (         int  )0;
     ...
     sqlstm.sqadto[70] = (unsigned short )0;
     sqlstm.sqtdso[70] = (unsigned short )0;
     sqlstm.sqhstv[71] = (unsigned char  *)&incomeded;
     sqlstm.sqhstl[71] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[71] = (         int  )0;
     sqlstm.sqindv[71] = (         short *)0;
     sqlstm.sqinds[71] = (         int  )0;
     ...
     sqlstm.sqadto[71] = (unsigned short )0;
     sqlstm.sqtdso[71] = (unsigned short )0;
     sqlstm.sqhstv[72] = (unsigned char  *)&splimitovded;
     sqlstm.sqhstl[72] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[72] = (         int  )0;
     sqlstm.sqindv[72] = (         short *)0;
     sqlstm.sqinds[72] = (         int  )0;
     ...
     sqlstm.sqadto[72] = (unsigned short )0;
     sqlstm.sqtdso[72] = (unsigned short )0;
     sqlstm.sqhstv[73] = (unsigned char  *)&nepgiveded;
     sqlstm.sqhstl[73] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[73] = (         int  )0;
     sqlstm.sqindv[73] = (         short *)0;
     sqlstm.sqinds[73] = (         int  )0;
     ...
     sqlstm.sqadto[73] = (unsigned short )0;
     sqlstm.sqtdso[73] = (unsigned short )0;
     sqlstm.sqhstv[74] = (unsigned char  *)&nepgiveded2;
     sqlstm.sqhstl[74] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[74] = (         int  )0;
     sqlstm.sqindv[74] = (         short *)0;
     sqlstm.sqinds[74] = (         int  )0;
     ...
     sqlstm.sqadto[74] = (unsigned short )0;
     sqlstm.sqtdso[74] = (unsigned short )0;
     sqlstm.sqhstv[75] = (unsigned char  *)&nagiveded;
     sqlstm.sqhstl[75] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[75] = (         int  )0;
     sqlstm.sqindv[75] = (         short *)0;
     sqlstm.sqinds[75] = (         int  )0;
     ...
     sqlstm.sqadto[75] = (unsigned short )0;
     sqlstm.sqtdso[75] = (unsigned short )0;
     sqlstm.sqhstv[76] = (unsigned char  *)&npgiveded;
     sqlstm.sqhstl[76] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[76] = (         int  )0;
     sqlstm.sqindv[76] = (         short *)0;
     sqlstm.sqinds[76] = (         int  )0;
     ...
     sqlstm.sqadto[76] = (unsigned short )0;
     sqlstm.sqtdso[76] = (unsigned short )0;
     sqlstm.sqhstv[77] = (unsigned char  *)&npgiveded2;
     sqlstm.sqhstl[77] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[77] = (         int  )0;
     sqlstm.sqindv[77] = (         short *)0;
     sqlstm.sqinds[77] = (         int  )0;
     ...
     sqlstm.sqadto[77] = (unsigned short )0;
     sqlstm.sqtdso[77] = (unsigned short )0;
     sqlstm.sqhstv[78] = (unsigned char  *)&ngiveded;
     sqlstm.sqhstl[78] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[78] = (         int  )0;
     sqlstm.sqindv[78] = (         short *)0;
     sqlstm.sqinds[78] = (         int  )0;
     ...
     sqlstm.sqadto[78] = (unsigned short )0;
     sqlstm.sqtdso[78] = (unsigned short )0;
     sqlstm.sqhstv[79] = (unsigned char  *)&investded3;
     sqlstm.sqhstl[79] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[79] = (         int  )0;
     sqlstm.sqindv[79] = (         short *)0;
     sqlstm.sqinds[79] = (         int  )0;
     ...
     sqlstm.sqadto[79] = (unsigned short )0;
     sqlstm.sqtdso[79] = (unsigned short )0;
     sqlstm.sqhstv[80] = (unsigned char  *)&longfundded;
     sqlstm.sqhstl[80] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[80] = (         int  )0;
     sqlstm.sqindv[80] = (         short *)0;
     sqlstm.sqinds[80] = (         int  )0;
     ...
     sqlstm.sqadto[80] = (unsigned short )0;
     sqlstm.sqtdso[80] = (unsigned short )0;
     sqlstm.sqhstv[81] = (unsigned char  *)&childtaxded;
     sqlstm.sqhstl[81] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[81] = (         int  )0;
     sqlstm.sqindv[81] = (         short *)0;
     sqlstm.sqinds[81] = (         int  )0;
     ...
     sqlstm.sqadto[81] = (unsigned short )0;
     sqlstm.sqtdso[81] = (unsigned short )0;
     sqlstm.sqhstv[82] = (unsigned char  *)&infanttaxded;
     sqlstm.sqhstl[82] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[82] = (         int  )0;
     sqlstm.sqindv[82] = (         short *)0;
     sqlstm.sqinds[82] = (         int  )0;
     ...
     sqlstm.sqadto[82] = (unsigned short )0;
     sqlstm.sqtdso[82] = (unsigned short )0;
     sqlstm.sqhstv[83] = (unsigned char  *)&addbabytaxded;
     sqlstm.sqhstl[83] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[83] = (         int  )0;
     sqlstm.sqindv[83] = (         short *)0;
     sqlstm.sqinds[83] = (         int  )0;
     ...
     sqlstm.sqadto[83] = (unsigned short )0;
     sqlstm.sqtdso[83] = (unsigned short )0;
     sqlstm.sqhstv[84] = (unsigned char  *)&npendtaxded;
     sqlstm.sqhstl[84] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[84] = (         int  )0;
     sqlstm.sqindv[84] = (         short *)0;
     sqlstm.sqinds[84] = (         int  )0;
     ...
     sqlstm.sqadto[84] = (unsigned short )0;
     sqlstm.sqtdso[84] = (unsigned short )0;
     sqlstm.sqhstv[85] = (unsigned char  *)&guartaxded;
     sqlstm.sqhstl[85] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[85] = (         int  )0;
     sqlstm.sqindv[85] = (         short *)0;
     sqlstm.sqinds[85] = (         int  )0;
     ...
     sqlstm.sqadto[85] = (unsigned short )0;
     sqlstm.sqtdso[85] = (unsigned short )0;
     sqlstm.sqhstv[86] = (unsigned char  *)&obsguartaxded;
     sqlstm.sqhstl[86] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[86] = (         int  )0;
     sqlstm.sqindv[86] = (         short *)0;
     sqlstm.sqinds[86] = (         int  )0;
     ...
     sqlstm.sqadto[86] = (unsigned short )0;
     sqlstm.sqtdso[86] = (unsigned short )0;
     sqlstm.sqhstv[87] = (unsigned char  *)&hostaxded;
     sqlstm.sqhstl[87] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[87] = (         int  )0;
     sqlstm.sqindv[87] = (         short *)0;
     sqlstm.sqinds[87] = (         int  )0;
     ...
     sqlstm.sqadto[87] = (unsigned short )0;
     sqlstm.sqtdso[87] = (unsigned short )0;
     sqlstm.sqhstv[88] = (unsigned char  *)&edutaxded;
     sqlstm.sqhstl[88] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[88] = (         int  )0;
     sqlstm.sqindv[88] = (         short *)0;
     sqlstm.sqinds[88] = (         int  )0;
     ...
     sqlstm.sqadto[88] = (unsigned short )0;
     sqlstm.sqtdso[88] = (unsigned short )0;
     sqlstm.sqhstv[89] = (unsigned char  *)&polided1;
     sqlstm.sqhstl[89] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[89] = (         int  )0;
     sqlstm.sqindv[89] = (         short *)0;
     sqlstm.sqinds[89] = (         int  )0;
     ...
     sqlstm.sqadto[89] = (unsigned short )0;
     sqlstm.sqtdso[89] = (unsigned short )0;
     sqlstm.sqhstv[90] = (unsigned char  *)&polided2;
     sqlstm.sqhstl[90] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[90] = (         int  )0;
     sqlstm.sqindv[90] = (         short *)0;
     sqlstm.sqinds[90] = (         int  )0;
     ...
     sqlstm.sqadto[90] = (unsigned short )0;
     sqlstm.sqtdso[90] = (unsigned short )0;
     sqlstm.sqhstv[91] = (unsigned char  *)&politaxded1;
     sqlstm.sqhstl[91] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[91] = (         int  )0;
     sqlstm.sqindv[91] = (         short *)0;
     sqlstm.sqinds[91] = (         int  )0;
     ...
     sqlstm.sqadto[91] = (unsigned short )0;
     sqlstm.sqtdso[91] = (unsigned short )0;
     sqlstm.sqhstv[92] = (unsigned char  *)&politaxded2;
     sqlstm.sqhstl[92] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[92] = (         int  )0;
     sqlstm.sqindv[92] = (         short *)0;
     sqlstm.sqinds[92] = (         int  )0;
     ...
     sqlstm.sqadto[92] = (unsigned short )0;
     sqlstm.sqtdso[92] = (unsigned short )0;
     sqlstm.sqhstv[93] = (unsigned char  *)&agivetaxded;
     sqlstm.sqhstl[93] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[93] = (         int  )0;
     sqlstm.sqindv[93] = (         short *)0;
     sqlstm.sqinds[93] = (         int  )0;
     ...
     sqlstm.sqadto[93] = (unsigned short )0;
     sqlstm.sqtdso[93] = (unsigned short )0;
     sqlstm.sqhstv[94] = (unsigned char  *)&pgivetaxded;
     sqlstm.sqhstl[94] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[94] = (         int  )0;
     sqlstm.sqindv[94] = (         short *)0;
     sqlstm.sqinds[94] = (         int  )0;
     ...
     sqlstm.sqadto[94] = (unsigned short )0;
     sqlstm.sqtdso[94] = (unsigned short )0;
     sqlstm.sqhstv[95] = (unsigned char  *)&taxdedsum;
     sqlstm.sqhstl[95] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[95] = (         int  )0;
     sqlstm.sqindv[95] = (         short *)0;
     sqlstm.sqinds[95] = (         int  )0;
     ...
     sqlstm.sqadto[95] = (unsigned short )0;
     sqlstm.sqtdso[95] = (unsigned short )0;
     sqlstm.sqhstv[96] = (unsigned char  *)&houserenttaxded;
     sqlstm.sqhstl[96] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[96] = (         int  )0;
     sqlstm.sqindv[96] = (         short *)0;
     sqlstm.sqinds[96] = (         int  )0;
     ...
     sqlstm.sqadto[96] = (unsigned short )0;
     sqlstm.sqtdso[96] = (unsigned short )0;
     sqlstm.sqhstv[97] = (unsigned char  *)&npgiveamt2_2010;
     sqlstm.sqhstl[97] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[97] = (         int  )0;
     sqlstm.sqindv[97] = (         short *)0;
     sqlstm.sqinds[97] = (         int  )0;
     ...
     sqlstm.sqadto[97] = (unsigned short )0;
     sqlstm.sqtdso[97] = (unsigned short )0;
     sqlstm.sqhstv[98] = (unsigned char  *)&npgiveamt2_else;
     sqlstm.sqhstl[98] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[98] = (         int  )0;
     sqlstm.sqindv[98] = (         short *)0;
     sqlstm.sqinds[98] = (         int  )0;
     ...
     sqlstm.sqadto[98] = (unsigned short )0;
     sqlstm.sqtdso[98] = (unsigned short )0;
     sqlstm.sqhstv[99] = (unsigned char  *)&nagiveamt_2014;
     sqlstm.sqhstl[99] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[99] = (         int  )0;
     sqlstm.sqindv[99] = (         short *)0;
     sqlstm.sqinds[99] = (         int  )0;
     ...
     sqlstm.sqadto[99] = (unsigned short )0;
     sqlstm.sqtdso[99] = (unsigned short )0;
     sqlstm.sqhstv[100] = (unsigned char  *)&npgiveamt_2014;
     sqlstm.sqhstl[100] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[100] = (         int  )0;
     sqlstm.sqindv[100] = (         short *)0;
     sqlstm.sqinds[100] = (         int  )0;
     ...
     sqlstm.sqadto[100] = (unsigned short )0;
     sqlstm.sqtdso[100] = (unsigned short )0;
     sqlstm.sqhstv[101] = (unsigned char  *)&npgiveamt2_2014;
     sqlstm.sqhstl[101] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[101] = (         int  )0;
     sqlstm.sqindv[101] = (         short *)0;
     sqlstm.sqinds[101] = (         int  )0;
     ...
     sqlstm.sqadto[101] = (unsigned short )0;
     sqlstm.sqtdso[101] = (unsigned short )0;
     sqlstm.sqhstv[102] = (unsigned char  *)&nagiveded_2014;
     sqlstm.sqhstl[102] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[102] = (         int  )0;
     sqlstm.sqindv[102] = (         short *)0;
     sqlstm.sqinds[102] = (         int  )0;
     ...
     sqlstm.sqadto[102] = (unsigned short )0;
     sqlstm.sqtdso[102] = (unsigned short )0;
     sqlstm.sqhstv[103] = (unsigned char  *)&npgiveded_2014;
     sqlstm.sqhstl[103] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[103] = (         int  )0;
     sqlstm.sqindv[103] = (         short *)0;
     sqlstm.sqinds[103] = (         int  )0;
     ...
     sqlstm.sqadto[103] = (unsigned short )0;
     sqlstm.sqtdso[103] = (unsigned short )0;
     sqlstm.sqhstv[104] = (unsigned char  *)&npgiveded2_2014;
     sqlstm.sqhstl[104] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[104] = (         int  )0;
     sqlstm.sqindv[104] = (         short *)0;
     sqlstm.sqinds[104] = (         int  )0;
     ...
     sqlstm.sqadto[104] = (unsigned short )0;
     sqlstm.sqtdso[104] = (unsigned short )0;
     sqlstm.sqhstv[105] = (unsigned char  *)&houseintded6;
     sqlstm.sqhstl[105] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[105] = (         int  )0;
     sqlstm.sqindv[105] = (         short *)0;
     sqlstm.sqinds[105] = (         int  )0;
     ...
     sqlstm.sqadto[105] = (unsigned short )0;
     sqlstm.sqtdso[105] = (unsigned short )0;
     sqlstm.sqhstv[106] = (unsigned char  *)&houseintded7;
     sqlstm.sqhstl[106] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[106] = (         int  )0;
     sqlstm.sqindv[106] = (         short *)0;
     sqlstm.sqinds[106] = (         int  )0;
     ...
     sqlstm.sqadto[106] = (unsigned short )0;
     sqlstm.sqtdso[106] = (unsigned short )0;
     sqlstm.sqhstv[107] = (unsigned char  *)&houseintded8;
     sqlstm.sqhstl[107] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[107] = (         int  )0;
     sqlstm.sqindv[107] = (         short *)0;
     sqlstm.sqinds[107] = (         int  )0;
     ...
     sqlstm.sqadto[107] = (unsigned short )0;
     sqlstm.sqtdso[107] = (unsigned short )0;
     sqlstm.sqhstv[108] = (unsigned char  *)&houseintded9;
     sqlstm.sqhstl[108] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[108] = (         int  )0;
     sqlstm.sqindv[108] = (         short *)0;
     sqlstm.sqinds[108] = (         int  )0;
     ...
     sqlstm.sqadto[108] = (unsigned short )0;
     sqlstm.sqtdso[108] = (unsigned short )0;
     sqlstm.sqhstv[109] = (unsigned char  *)&investded4;
     sqlstm.sqhstl[109] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[109] = (         int  )0;
     sqlstm.sqindv[109] = (         short *)0;
     sqlstm.sqinds[109] = (         int  )0;
     ...
     sqlstm.sqadto[109] = (unsigned short )0;
     sqlstm.sqtdso[109] = (unsigned short )0;
     sqlstm.sqhstv[110] = (unsigned char  *)&rpended;
     sqlstm.sqhstl[110] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[110] = (         int  )0;
     sqlstm.sqindv[110] = (         short *)0;
     sqlstm.sqinds[110] = (         int  )0;
     ...
     sqlstm.sqadto[110] = (unsigned short )0;
     sqlstm.sqtdso[110] = (unsigned short )0;
     sqlstm.sqhstv[111] = (unsigned char  *)&rpentaxded;
     sqlstm.sqhstl[111] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[111] = (         int  )0;
     sqlstm.sqindv[111] = (         short *)0;
     sqlstm.sqinds[111] = (         int  )0;
     ...
     sqlstm.sqadto[111] = (unsigned short )0;
     sqlstm.sqtdso[111] = (unsigned short )0;
     sqlstm.sqhstv[112] = (unsigned char  *)&taxlevel;
     sqlstm.sqhstl[112] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[112] = (         int  )0;
     sqlstm.sqindv[112] = (         short *)0;
     sqlstm.sqinds[112] = (         int  )0;
     ...
     sqlstm.sqadto[112] = (unsigned short )0;
     sqlstm.sqtdso[112] = (unsigned short )0;
     sqlstm.sqhstv[113] = (unsigned char  *)&calctax;
     sqlstm.sqhstl[113] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[113] = (         int  )0;
     sqlstm.sqindv[113] = (         short *)0;
     sqlstm.sqinds[113] = (         int  )0;
     ...
     sqlstm.sqadto[113] = (unsigned short )0;
     sqlstm.sqtdso[113] = (unsigned short )0;
     sqlstm.sqhstv[114] = (unsigned char  *)&dintax;
     sqlstm.sqhstl[114] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[114] = (         int  )0;
     sqlstm.sqindv[114] = (         short *)0;
     sqlstm.sqinds[114] = (         int  )0;
     ...
     sqlstm.sqadto[114] = (unsigned short )0;
     sqlstm.sqtdso[114] = (unsigned short )0;
     sqlstm.sqhstv[115] = (unsigned char  *)&djutax;
     sqlstm.sqhstl[115] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[115] = (         int  )0;
     sqlstm.sqindv[115] = (         short *)0;
     sqlstm.sqinds[115] = (         int  )0;
     ...
     sqlstm.sqadto[115] = (unsigned short )0;
     sqlstm.sqtdso[115] = (unsigned short )0;
     sqlstm.sqhstv[116] = (unsigned char  *)&dnongtax;
     sqlstm.sqhstl[116] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[116] = (         int  )0;
     sqlstm.sqindv[116] = (         short *)0;
     sqlstm.sqinds[116] = (         int  )0;
     ...
     sqlstm.sqadto[116] = (unsigned short )0;
     sqlstm.sqtdso[116] = (unsigned short )0;
     sqlstm.sqhstv[117] = (unsigned char  *)&intax;
     sqlstm.sqhstl[117] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[117] = (         int  )0;
     sqlstm.sqindv[117] = (         short *)0;
     sqlstm.sqinds[117] = (         int  )0;
     ...
     sqlstm.sqadto[117] = (unsigned short )0;
     sqlstm.sqtdso[117] = (unsigned short )0;
     sqlstm.sqhstv[118] = (unsigned char  *)&jutax;
     sqlstm.sqhstl[118] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[118] = (         int  )0;
     sqlstm.sqindv[118] = (         short *)0;
     sqlstm.sqinds[118] = (         int  )0;
     ...
     sqlstm.sqadto[118] = (unsigned short )0;
     sqlstm.sqtdso[118] = (unsigned short )0;
     sqlstm.sqhstv[119] = (unsigned char  *)&nongtax;
     sqlstm.sqhstl[119] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[119] = (         int  )0;
     sqlstm.sqindv[119] = (         short *)0;
     sqlstm.sqinds[119] = (         int  )0;
     ...
     sqlstm.sqadto[119] = (unsigned short )0;
     sqlstm.sqtdso[119] = (unsigned short )0;
     sqlstm.sqhstv[120] = (unsigned char  *)&yintax;
     sqlstm.sqhstl[120] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[120] = (         int  )0;
     sqlstm.sqindv[120] = (         short *)0;
     sqlstm.sqinds[120] = (         int  )0;
     ...
     sqlstm.sqadto[120] = (unsigned short )0;
     sqlstm.sqtdso[120] = (unsigned short )0;
     sqlstm.sqhstv[121] = (unsigned char  *)&yjutax;
     sqlstm.sqhstl[121] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[121] = (         int  )0;
     sqlstm.sqindv[121] = (         short *)0;
     sqlstm.sqinds[121] = (         int  )0;
     ...
     sqlstm.sqadto[121] = (unsigned short )0;
     sqlstm.sqtdso[121] = (unsigned short )0;
     sqlstm.sqhstv[122] = (unsigned char  *)&ynongtax;
     sqlstm.sqhstl[122] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[122] = (         int  )0;
     sqlstm.sqindv[122] = (         short *)0;
     sqlstm.sqinds[122] = (         int  )0;
     ...
     sqlstm.sqadto[122] = (unsigned short )0;
     sqlstm.sqtdso[122] = (unsigned short )0;
     sqlstm.sqhstv[123] = (unsigned char  *)&ycalctax;
     sqlstm.sqhstl[123] = (unsigned long )sizeof(double);
     sqlstm.sqhsts[123] = (         int  )0;
     sqlstm.sqindv[123] = (         short *)0;
     sqlstm.sqinds[123] = (         int  )0;
     ...
     sqlstm.sqadto[123] = (unsigned short )0;
     sqlstm.sqtdso[123] = (unsigned short )0;
     sqlstm.sqhstv[124] = (unsigned char  *)log_subdate;
     sqlstm.sqhstl[124] = (unsigned long )9;
     sqlstm.sqhsts[124] = (         int  )0;
     sqlstm.sqindv[124] = (         short *)0;
     sqlstm.sqinds[124] = (         int  )0;
     sqlstm.sqharm[124] = (unsigned long )0;
     sqlstm.sqadto[124] = (unsigned short )0;
     sqlstm.sqtdso[124] = (unsigned short )0;
     sqlstm.sqhstv[125] = (unsigned char  *)writeman;
     sqlstm.sqhstl[125] = (unsigned long )5;
     sqlstm.sqhsts[125] = (         int  )0;
     sqlstm.sqindv[125] = (         short *)0;
     sqlstm.sqinds[125] = (         int  )0;
     sqlstm.sqharm[125] = (unsigned long )0;
     sqlstm.sqadto[125] = (unsigned short )0;
     sqlstm.sqtdso[125] = (unsigned short )0;
     sqlstm.sqhstv[126] = (unsigned char  *)empno;
...
/*
hinsacc pkz3010g
mv pkz3010g ~/HINSA/proc/bin/Kbin
/hper/insa/HINSA/proc/bin/Kbin/pkz3010g 20160310 D025 pkz3010g 201603100000
*/